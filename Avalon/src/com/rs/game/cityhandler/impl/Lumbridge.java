        ...
        switch (npc.getId()) {
            ...
            case 7969:
                if (player.getTaskManager().hasCompletedTasks("easy")) {
                    ...
                    player.getDialogue().sendNPCDialogue(npc.getId(), 9850, "Here you go! They are well deserved.");
                } else {
                    player.getDialogue().sendNPCDialogue(npc.getId(), 9836, "You have nothing to claim.");
                }
                break;
