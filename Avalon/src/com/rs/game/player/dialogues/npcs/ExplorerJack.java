...
public class ExplorerJack extends Dialogue {
	...
	public void start() {
		sendNPCDialogue(npc, Happy,
				"Aha! Hello " + player.getDisplayName() + ". Do you have some questions about the task system?");
		stage = 1;
	...
	public void run(int interfaceId, int componentId) {
		...
		case 2:
			...
			case OPTION_1:
				sendNPCDialogue(npc, Happy,
						"The Task System is a guide in some sort, the purpose of it is to prove your skills, techniques and such around the world of " + Settings.SERVER_NAME + ".");
				stage = 1;
				break;
			case OPTION_2:
