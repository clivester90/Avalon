		...
		if (stage == 0) {
			...
			if (componentId == OPTION_1) {
				sendNPCDialogue(npcId, 9827,
						"This is the Artisan workshop the best place for training Smithing. Only "+ Settings.FORMAL_SERVER_NAME +" members can access this area.");
				stage = 0;
				...
				if (player.isMember() || player.isDeveloper()) {
					...
					player.sm("You need to be a "+ Settings.FORMAL_SERVER_NAME +" Member to access this area.");
					end();
				}
			} else {
				end();
