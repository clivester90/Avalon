...
public class Class240_Sub1 extends Class240 {
	...
	try {
	    ...
	    if (null != interface3) {
		ObjectDefinitions class432 = (this.aClass433_7072.getObjectDefinitions(interface3.method32((byte) 80)));
		...
		if (i_0_ == 0) {
		    ...
		    if (0 != class432.clip_type * -2144543407)
			class289.method2743(i_1_, i_2_, i_4_, i_5_, class432.clip_solid, !class432.clip_unknown, (byte) 108);
		    ...
		    if (0 != class432.clip_type * -2144543407 && (-1125834887 * class432.sizeX + i_1_ < anInt2627 * -954368823) && (-1125834887 * class432.sizeX + i_2_ < anInt2628 * 181474463) && (-565161399 * class432.sizeY + i_1_ < anInt2627 * -954368823) && (-565161399 * class432.sizeY + i_2_ < 181474463 * anInt2628))
			class289.method2736(i_1_, i_2_, class432.sizeX * -1125834887, -565161399 * class432.sizeY, i_5_, class432.clip_solid, !class432.clip_unknown, (byte) 38);
		    if (GameObjectType.T9.type * -1976050083 == i_4_) {
			if ((i_5_ & 0x1) == 0)
		    ...
		    if (class432.clip_type * -2144543407 == 1)
	...
	try {
		...
		while_0_: do {
			...
			if (i_8_ == 0) {
			    if (class385 == null)
				class385 = new Class385(class298_sub53, (this.aClass364_7080));
			    else
				class385.method4706(class298_sub53, (this.aClass364_7080), (short) 1342);
			} else if (1 == i_8_) {
			    ...
			    if (class385 == null)
				class385 = new Class385();
			    class385.method4712(class298_sub53, (this.aClass364_7080), (byte) 11);
			} else {
			    if (129 != i_8_)
				break;
		...
		if (class385 != null) {
			...
			for (int i_31_ = 0; i_31_ < 8; i_31_++) {
				...
				this.aClass364_7080.method4319(i_32_, i_33_, class385, (byte) -2);
			}
		    }
		}
	...
	try {
		...
		while_1_: do {
			...
			if (0 == i_48_) {
				...
				class385.method4706(class298_sub53, (this.aClass364_7080), (short) 1534);
			} else if (1 == i_48_) {
			    ...
			    if (null == class385)
				class385 = new Class385();
			    class385.method4712(class298_sub53, (this.aClass364_7080), (byte) 53);
			} else {
			    if (i_48_ != 129)
				break;
		...
		while (false);
		if (class385 != null)
		    this.aClass364_7080.method4319(i_39_ >> 3, i_40_ >> 3, class385, (byte) -31);
	...
	try {
		...
		for (;;) {
			...
			ObjectDefinitions class432 = this.aClass433_7072.getObjectDefinitions(i_94_);
	...
	try {
	    if (-1976050083 * GameObjectType.T0.type == i) {
		...
		if (bool) {
		    Class365_Sub1_Sub5_Sub1 class365_sub1_sub5_sub1 = new Class365_Sub1_Sub5_Sub1(aClass331_2619, class_ra, (this.aClass433_7072), class432, i_109_, i_110_, i_111_, i_112_, i_113_, aBoolean2629, i, i_107_, bool_116_);
		    ...
		    class365_sub1_sub5 = new Class365_Sub1_Sub5_Sub2(aClass331_2619, class_ra, (this.aClass433_7072), class432, i_109_, i_110_, i_111_, i_112_, i_113_, aBoolean2629, i, i_107_, i_108_);
		...
		if (0 != -2144543407 * class432.clip_type && class289 != null)
		    class289.method2732(i_114_, i_115_, i, i_107_, class432.clip_solid, !class432.clip_unknown, (byte) 0);
		if (-448694871 * class432.anInt5391 != 64)
		    aClass331_2619.method4023(i_109_, i_114_, i_115_, class432.anInt5391 * -448694871, (byte) -54);
		return true;
	    }
	    if (i == -1976050083 * GameObjectType.T1.type) {
		Class365_Sub1_Sub5 class365_sub1_sub5;
		if (bool) {
		    Class365_Sub1_Sub5_Sub1 class365_sub1_sub5_sub1 = new Class365_Sub1_Sub5_Sub1(aClass331_2619, class_ra, (this.aClass433_7072), class432, i_109_, i_110_, i_111_, i_112_, i_113_, aBoolean2629, i, i_107_, bool_116_);
		...
		if (-2144543407 * class432.clip_type != 0 && null != class289)
		    class289.method2732(i_114_, i_115_, i, i_107_, class432.clip_solid, !class432.clip_unknown, (byte) 0);
		return true;
	    }
	    if (i == -1976050083 * GameObjectType.T2.type) {
		int i_121_ = i_107_ + 1 & 0x3;
		Class365_Sub1_Sub5 class365_sub1_sub5;
		Class365_Sub1_Sub5 class365_sub1_sub5_122_;
		if (bool) {
		    Class365_Sub1_Sub5_Sub1 class365_sub1_sub5_sub1 = new Class365_Sub1_Sub5_Sub1(aClass331_2619, class_ra, (this.aClass433_7072), class432, i_109_, i_110_, i_111_, i_112_, i_113_, aBoolean2629, i, 4 + i_107_, bool_116_);
		    Class365_Sub1_Sub5_Sub1 class365_sub1_sub5_sub1_123_ = new Class365_Sub1_Sub5_Sub1(aClass331_2619, class_ra, (this.aClass433_7072), class432, i_109_, i_110_, i_111_, i_112_, i_113_, aBoolean2629, i, i_121_, bool_116_);
		    ...
		    class365_sub1_sub5 = new Class365_Sub1_Sub5_Sub2(aClass331_2619, class_ra, (this.aClass433_7072), class432, i_109_, i_110_, i_111_, i_112_, i_113_, aBoolean2629, i, 4 + i_107_, i_108_);
		    class365_sub1_sub5_122_ = new Class365_Sub1_Sub5_Sub2(aClass331_2619, class_ra, (this.aClass433_7072), class432, i_109_, i_110_, i_111_, i_112_, i_113_, aBoolean2629, i, i_121_, i_108_);
		}
	    ...
	    if (i == -1976050083 * GameObjectType.T3.type) {
		Class365_Sub1_Sub5 class365_sub1_sub5;
		if (bool) {
		    Class365_Sub1_Sub5_Sub1 class365_sub1_sub5_sub1 = new Class365_Sub1_Sub5_Sub1(aClass331_2619, class_ra, (this.aClass433_7072), class432, i_109_, i_110_, i_111_, i_112_, i_113_, aBoolean2629, i, i_107_, bool_116_);
		...
		if (class432.clip_type * -2144543407 != 0 && class289 != null)
		    class289.method2732(i_114_, i_115_, i, i_107_, class432.clip_solid, !class432.clip_unknown, (byte) 0);
		return true;
	    }
	    if (i == -1976050083 * GameObjectType.T9.type) {
		Class365_Sub1_Sub1 class365_sub1_sub1;
		if (bool) {
		    Class365_Sub1_Sub1_Sub6 class365_sub1_sub1_sub6 = new Class365_Sub1_Sub1_Sub6(aClass331_2619, class_ra, (this.aClass433_7072), class432, i_109_, i_110_, i_111_, i_112_, i_113_, aBoolean2629, i_114_, i_114_, i_115_, i_115_, i, i_107_, bool_116_);
		    ...
		    class365_sub1_sub1 = new Class365_Sub1_Sub1_Sub5(aClass331_2619, class_ra, (this.aClass433_7072), class432, i_109_, i_110_, i_111_, i_112_, i_113_, aBoolean2629, i_114_, i_117_ + i_114_ - 1, i_115_, i_115_ + i_118_ - 1, i, i_107_, i_108_);
		...
		if (class432.clip_type * -2144543407 != 0 && null != class289)
		    class289.method2741(i_114_, i_115_, i_117_, i_118_, class432.clip_solid, !class432.clip_unknown, (byte) 2);
		if (class432.anInt5391 * -448694871 != 64)
	...
	try {
	    if (i == -1976050083 * GameObjectType.T4.type) {
		Class365_Sub1_Sub3 class365_sub1_sub3;
		if (bool) {
		    Class365_Sub1_Sub3_Sub2 class365_sub1_sub3_sub2 = new Class365_Sub1_Sub3_Sub2(aClass331_2619, class_ra, (this.aClass433_7072), class432, i_127_, i_128_, i_129_, i_130_, i_131_, aBoolean2629, 0, 0, i, i_125_);
		    ...
		    class365_sub1_sub3 = new Class365_Sub1_Sub3_Sub1(aClass331_2619, class_ra, (this.aClass433_7072), class432, i_127_, i_128_, i_129_, i_130_, i_131_, aBoolean2629, 0, 0, i, i_125_, i_126_);
		aClass331_2619.method4021(i_127_, i_132_, i_133_, class365_sub1_sub3, null, 861548591);
		return true;
	    }
	    if (i == GameObjectType.T5.type * -1976050083) {
		int i_135_ = 65;
		Interface3 interface3 = ((Interface3) aClass331_2619.method4031(i_127_, i_132_, i_133_, 644917110));
		if (null != interface3)
		    i_135_ = (this.aClass433_7072.getObjectDefinitions(interface3.method32((byte) 27)).anInt5391) * -448694871 + 1;
		Class365_Sub1_Sub3 class365_sub1_sub3;
		if (bool) {
		    Class365_Sub1_Sub3_Sub2 class365_sub1_sub3_sub2 = (new Class365_Sub1_Sub3_Sub2(aClass331_2619, class_ra, this.aClass433_7072, class432, i_127_, i_128_, i_129_, i_130_, i_131_, aBoolean2629, anIntArray7078[i_125_] * i_135_, anIntArray7075[i_125_] * i_135_, i, i_125_));
		    if (class365_sub1_sub3_sub2.method39(-1591018559))
			class365_sub1_sub3_sub2.method33(class_ra, -2011263790);
		    class365_sub1_sub3 = class365_sub1_sub3_sub2;
		} else
		    class365_sub1_sub3 = (new Class365_Sub1_Sub3_Sub1(aClass331_2619, class_ra, this.aClass433_7072, class432, i_127_, i_128_, i_129_, i_130_, i_131_, aBoolean2629, i_135_ * anIntArray7078[i_125_], i_135_ * anIntArray7075[i_125_], i, i_125_, i_126_));
		aClass331_2619.method4021(i_127_, i_132_, i_133_, class365_sub1_sub3, null, 1859376340);
		return true;
	    }
	    if (-1976050083 * GameObjectType.T6.type == i) {
		int i_136_ = 33;
		Interface3 interface3 = ((Interface3) aClass331_2619.method4031(i_127_, i_132_, i_133_, 552550945));
		if (interface3 != null)
		    i_136_ = (this.aClass433_7072.getObjectDefinitions(interface3.method32((byte) 14)).anInt5391) * -448694871 / 2 + 1;
		Class365_Sub1_Sub3 class365_sub1_sub3;
		if (bool) {
		    Class365_Sub1_Sub3_Sub2 class365_sub1_sub3_sub2 = (new Class365_Sub1_Sub3_Sub2(aClass331_2619, class_ra, this.aClass433_7072, class432, i_127_, i_128_, i_129_, i_130_, i_131_, aBoolean2629, i_136_ * anIntArray7078[i_125_], i_136_ * anIntArray7075[i_125_], i, i_125_ + 4));
		    if (class365_sub1_sub3_sub2.method39(-1847078642))
			class365_sub1_sub3_sub2.method33(class_ra, -2043548826);
		    class365_sub1_sub3 = class365_sub1_sub3_sub2;
		} else
		    class365_sub1_sub3 = (new Class365_Sub1_Sub3_Sub1(aClass331_2619, class_ra, this.aClass433_7072, class432, i_127_, i_128_, i_129_, i_130_, i_131_, aBoolean2629, i_136_ * anIntArray7074[i_125_], anIntArray7081[i_125_] * i_136_, i, i_125_ + 4, i_126_));
		aClass331_2619.method4021(i_127_, i_132_, i_133_, class365_sub1_sub3, null, 1431954302);
		return true;
	    }
	    if (-1976050083 * GameObjectType.T7.type == i) {
		int i_137_ = i_125_ + 2 & 0x3;
		Class365_Sub1_Sub3 class365_sub1_sub3;
		if (bool) {
		    Class365_Sub1_Sub3_Sub2 class365_sub1_sub3_sub2 = new Class365_Sub1_Sub3_Sub2(aClass331_2619, class_ra, (this.aClass433_7072), class432, i_127_, i_128_, i_129_, i_130_, i_131_, aBoolean2629, 0, 0, i, i_137_ + 4);
		    if (class365_sub1_sub3_sub2.method39(-1553150372))
			class365_sub1_sub3_sub2.method33(class_ra, -2133567145);
		    class365_sub1_sub3 = class365_sub1_sub3_sub2;
		} else
		    class365_sub1_sub3 = new Class365_Sub1_Sub3_Sub1(aClass331_2619, class_ra, (this.aClass433_7072), class432, i_127_, i_128_, i_129_, i_130_, i_131_, aBoolean2629, 0, 0, i, i_137_ + 4, i_126_);
		aClass331_2619.method4021(i_127_, i_132_, i_133_, class365_sub1_sub3, null, 1921538390);
		return true;
	    }
	    if (GameObjectType.T8.type * -1976050083 == i) {
		int i_138_ = i_125_ + 2 & 0x3;
		int i_139_ = 33;
		Interface3 interface3 = ((Interface3) aClass331_2619.method4031(i_127_, i_132_, i_133_, 2110046759));
		if (null != interface3)
		    i_139_ = (this.aClass433_7072.getObjectDefinitions(interface3.method32((byte) 14)).anInt5391) * -448694871 / 2 + 1;
		Class365_Sub1_Sub3 class365_sub1_sub3;
		Class365_Sub1_Sub3 class365_sub1_sub3_140_;
		if (bool) {
		    Class365_Sub1_Sub3_Sub2 class365_sub1_sub3_sub2 = (new Class365_Sub1_Sub3_Sub2(aClass331_2619, class_ra, this.aClass433_7072, class432, i_127_, i_128_, i_129_, i_130_, i_131_, aBoolean2629, i_139_ * anIntArray7074[i_125_], anIntArray7081[i_125_] * i_139_, i, i_125_ + 4));
		    Class365_Sub1_Sub3_Sub2 class365_sub1_sub3_sub2_141_ = new Class365_Sub1_Sub3_Sub2(aClass331_2619, class_ra, (this.aClass433_7072), class432, i_127_, i_128_, i_129_, i_130_, i_131_, aBoolean2629, 0, 0, i, i_138_ + 4);
		    ...
		    Class365_Sub1_Sub3_Sub1 class365_sub1_sub3_sub1 = (new Class365_Sub1_Sub3_Sub1(aClass331_2619, class_ra, this.aClass433_7072, class432, i_127_, i_128_, i_129_, i_130_, i_131_, aBoolean2629, i_139_ * anIntArray7074[i_125_], i_139_ * anIntArray7081[i_125_], i, i_125_ + 4, i_126_));
		    Class365_Sub1_Sub3_Sub1 class365_sub1_sub3_sub1_142_ = new Class365_Sub1_Sub3_Sub1(aClass331_2619, class_ra, (this.aClass433_7072), class432, i_127_, i_128_, i_129_, i_130_, i_131_, aBoolean2629, 0, 0, i, 4 + i_138_, i_126_);
	...
	try {
	    if (i_161_ < -1281303921 * this.anInt7082)
		this.anInt7082 = 272172143 * i_161_;
	    ObjectDefinitions class432 = this.aClass433_7072.getObjectDefinitions(i_164_);
		...
		if (!aBoolean7084 || ((!Class82_Sub9.isWall(i_166_, (byte) 13) || class432.anInt5376 * -1508517619 == 1) && (!Class111.method1236(i_166_, 1378507148) || 0 != -1508517619 * class432.anInt5376))) {
		    if (i_166_ == -1976050083 * GameObjectType.T22.type) {
			if ((Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub2_7547.method5629(-807116560) != 0) || class432.anInt5382 * 1532834983 != 0 || -2144543407 * class432.clip_type == 1 || class432.aBoolean5410) {
			    Class365_Sub1_Sub2 class365_sub1_sub2;
			    if (bool_178_) {
				Class365_Sub1_Sub2_Sub2 class365_sub1_sub2_sub2 = (new Class365_Sub1_Sub2_Sub2(aClass331_2619, class_ra, this.aClass433_7072, class432, i_161_, i, i_176_, i_175_, i_177_, aBoolean2629, i_165_, bool));
				...
				class365_sub1_sub2 = (new Class365_Sub1_Sub2_Sub1(aClass331_2619, class_ra, this.aClass433_7072, class432, i_161_, i, i_176_, i_175_, i_177_, aBoolean2629, i_165_, i_167_));
			    aClass331_2619.method4057(i_161_, i_162_, i_163_, class365_sub1_sub2, 1853221006);
			    if (1 == class432.clip_type * -2144543407 && null != class289)
				class289.method2734(i_162_, i_163_, (byte) 2);
			}
		    } else if ((-1976050083 * GameObjectType.T10.type == i_166_) || i_166_ == -1976050083 * (GameObjectType.T11.type)) {
			Class365_Sub1_Sub1_Sub6 class365_sub1_sub1_sub6 = null;
			Class365_Sub1_Sub1 class365_sub1_sub1;
			int i_179_;
			if (bool_178_) {
			    Class365_Sub1_Sub1_Sub6 class365_sub1_sub1_sub6_180_ = (new Class365_Sub1_Sub1_Sub6(aClass331_2619, class_ra, this.aClass433_7072, class432, i_161_, i, i_176_, i_175_, i_177_, aBoolean2629, i_162_, i_162_ + i_169_ - 1, i_163_, i_170_ + i_163_ - 1, i_166_, i_165_, bool));
			    ...
			    class365_sub1_sub1 = (new Class365_Sub1_Sub1_Sub5(aClass331_2619, class_ra, this.aClass433_7072, class432, i_161_, i, i_176_, i_175_, i_177_, aBoolean2629, i_162_, i_162_ + i_169_ - 1, i_163_, i_163_ + i_170_ - 1, i_166_, i_165_, i_167_));
			    i_179_ = 15;
			}
			...
			if (class432.clip_type * -2144543407 != 0 && null != class289)
			    class289.method2741(i_162_, i_163_, i_169_, i_170_, class432.clip_solid, !class432.clip_unknown, (byte) 15);
		    } else if (Class111.method1236(i_166_, -865214392) || Class207.method1930(i_166_, (byte) -21)) {
			Class365_Sub1_Sub1 class365_sub1_sub1;
			if (bool_178_) {
			    Class365_Sub1_Sub1_Sub6 class365_sub1_sub1_sub6 = (new Class365_Sub1_Sub1_Sub6(aClass331_2619, class_ra, this.aClass433_7072, class432, i_161_, i, i_176_, i_175_, i_177_, aBoolean2629, i_162_, i_169_ + i_162_ - 1, i_163_, i_170_ + i_163_ - 1, i_166_, i_165_, bool));
			    ...
			    class365_sub1_sub1 = (new Class365_Sub1_Sub1_Sub5(aClass331_2619, class_ra, this.aClass433_7072, class432, i_161_, i, i_176_, i_175_, i_177_, aBoolean2629, i_162_, i_162_ + i_169_ - 1, i_163_, i_163_ + i_170_ - 1, i_166_, i_165_, i_167_));
			aClass331_2619.method4022(class365_sub1_sub1, false, (byte) 0);
			if (aBoolean2632 && !aBoolean2629 && Class111.method1236(i_166_, 1932287279) && (-1976050083 * GameObjectType.T13.type != i_166_) && i_161_ > 0 && class432.anInt5376 * -1508517619 != 0)
			    aByteArrayArrayArray2637[i_161_][i_162_][i_163_] |= 0x4;
			if (0 != class432.clip_type * -2144543407 && null != class289)
			    class289.method2741(i_162_, i_163_, i_169_, i_170_, class432.clip_solid, !class432.clip_unknown, (byte) 4);
	...
	this.aClass433_7072 = class433;
	this.aClass364_7080 = class364;
    }

    static final void method2244(IComponentDefinition class105, Class119 class119, Class403 class403, byte i) {
	try {
    ...
    static final void method2245(Class403 class403, int i) {
	try {
	    class403.anInt5239 -= -1959403445;
	    int i_185_ = (class403.anIntArray5244[class403.anInt5239 * 681479919]);
	    int i_186_ = (class403.anIntArray5244[681479919 * class403.anInt5239 + 1]);
	    int i_187_ = (class403.anIntArray5244[681479919 * class403.anInt5239 + 2]);
	    int i_188_ = (class403.anIntArray5244[3 + 681479919 * class403.anInt5239]);
	    int i_189_ = (class403.anIntArray5244[4 + 681479919 * class403.anInt5239]);
	    if (-1 == i_187_)
    ...
    static final void method2246(Class403 class403, int i) {
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (1548853569 * class105.anInt1184 == 1 ? class105.anInt1151 * 572201537 : -1);
	}
	catch (RuntimeException runtimeexception) {
