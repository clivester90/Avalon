...
public class Class411 {
    ...
    public static Class411 game_rs = new Class411("718Runescape", "718Runescape", 0);
	...
	try {
	    long l = i << 28 | i_5_ << 14 | i_4_;
	    Class298_Sub2 class298_sub2 = (Class298_Sub2) client.aClass437_8685.method5812(l);
	...
	try {
		...
		if (null == class105) {
			...
			method5578(class105s, class105.ihash * -440872681, (byte) 1);
			if (class105.aClass105Array1293 != null)
			    method5578(class105.aClass105Array1293, class105.ihash * -440872681, (byte) 1);
			Interface class298_sub51 = ((Interface) (client.aClass437_8841.method5812(class105.ihash * -440872681)));
	...
	try {
	    ...
	    client.aClass25_8693.method384((byte) 113);
	    ...
	    client.aClass437_8825.method5811((byte) -106);
	    client.aClass442_8650.method5869(585418023);
	    client.aClass437_8685.method5811((byte) -42);
	    ...
	    Class21.anInt276 = 0;
	    Class_xa.cameraLookViewLocalX = 0;
		...
		client.GRAND_EXCHANGE_SLOTS[i_17_] = new Class251();
	...
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (Class84.aClass305_770.method3747("jagtheora", -935061597) ? 1 : 0);
	}
	catch (RuntimeException runtimeexception) {
