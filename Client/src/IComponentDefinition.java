...
public class IComponentDefinition {
    ...
    public Object[] anObjectArray1122;
    ...
    public static Class348 aClass348_1135;
    static Class348 aClass348_1136;
    public Object[] anObjectArray1137;
    public static Class348 aClass348_1138;
    public static boolean aBoolean1139;
    public int anInt1140;
    public int anInt1141;
    public int ihash = -533296807;
    ...
    public Class351 aClass351_1218;
    public Class298_Sub38 aClass298_Sub38_1219;
	...
	try {
		...
		return string;
	    Class298_Sub29 class298_sub29 = ((Class298_Sub29) this.aClass437_1279.method5812(i));
	    if (class298_sub29 == null)
		return string;
	    return (String) class298_sub29.anObject7366;
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eg.aa(").append(')').toString());
	}
    }

    void method1110(RsByteBuffer stream, int i) {
	try {
	    int i_1_ = stream.readUnsignedByte();
	    if (i_1_ == 255)
		i_1_ = -1;
	    type = stream.readUnsignedByte() * -800405999;
	    if ((-1215239439 * type & 0x80) != 0) {
		type = -800405999 * (type * -1215239439 & 0x7f);
		aString1259 = stream.readString(-53135184);
	    }
	    anInt1145 = stream.readUnsignedShort() * -680446123;
	    anInt1286 = stream.readShort(1719356411) * 2145953887;
	    anInt1159 = stream.readShort(2010058143) * 1215865909;
	    anInt1253 = stream.readUnsignedShort() * -478399925;
	    anInt1153 = stream.readUnsignedShort() * -1661995333;
	    aByte1148 = stream.readByte(-12558881);
	    aByte1149 = stream.readByte(-12558881);
	    aByte1146 = stream.readByte(-12558881);
	    aByte1147 = stream.readByte(-12558881);
	    anInt1160 = stream.readUnsignedShort() * -1171161349;
	    if (65535 == anInt1160 * 1573706803)
		anInt1160 = 1171161349;
	    else
		anInt1160 = (anInt1160 * 1573706803 + (-440872681 * ihash & ~0xffff)) * -1171161349;
	    // after here
	    int flag = stream.readUnsignedByte();
	    aBoolean1161 = 0 != (flag & 0x1);
	    if (i_1_ >= 0)
		aBoolean1165 = (flag & 0x2) != 0;
	    if (0 == type * -1215239439) {
		anInt1168 = stream.readUnsignedShort() * -1609060375;
		anInt1169 = stream.readUnsignedShort() * -1638942269;
		if (i_1_ < 0) {
		    aBoolean1165 = stream.readUnsignedByte() == 1;
		}
	    }
	    if (-1215239439 * type == 5) {
		spriteId = stream.readInt((byte) 91) * 1986266571;
		anInt1306 = stream.readUnsignedShort() * -216431639;
		int i_3_ = stream.readUnsignedByte();
		aBoolean1196 = 0 != (i_3_ & 0x1);
		aBoolean1182 = (i_3_ & 0x2) != 0;
		anInt1223 = stream.readUnsignedByte() * 728904583;
		anInt1178 = stream.readUnsignedByte() * 1158843261;
		anInt1251 = stream.readInt((byte) -62) * -1448553585;
		aBoolean1180 = stream.readUnsignedByte() == 1;
		aBoolean1181 = stream.readUnsignedByte() == 1;
		anInt1170 = stream.readInt((byte) -1) * -695431873;
		if (i_1_ >= 3)
		    aBoolean1183 = stream.readUnsignedByte() == 1;
	    }
	    if (6 == -1215239439 * type) {
		anInt1184 = -1530138943;
		anInt1151 = stream.readBigSmart(1235052657) * -1825442367;
		...
		if (bool) {
		    anInt1193 = stream.readShort(1863144228) * 437213185;
		    anInt1194 = stream.readShort(1761728846) * 1266800241;
		    anInt1190 = stream.readUnsignedShort() * -801721775;
		    anInt1262 = stream.readUnsignedShort() * 1590511671;
		    anInt1192 = stream.readUnsignedShort() * -2064327287;
		    anInt1284 = stream.readUnsignedShort() * -1066050969;
		} else if (aBoolean1187) {
		    anInt1193 = stream.readShort(1670425609) * 437213185;
		    anInt1194 = stream.readShort(1566977554) * 1266800241;
		    anInt1282 = stream.readShort(1594666911) * -1324973519;
		    anInt1190 = stream.readUnsignedShort() * -801721775;
		    anInt1262 = stream.readUnsignedShort() * 1590511671;
		    anInt1192 = stream.readUnsignedShort() * -2064327287;
		    anInt1284 = stream.readShort(1622637773) * -1066050969;
		}
		anInt1290 = stream.readBigSmart(1235052657) * 1587382585;
		if (0 != aByte1148)
		    anInt1221 = stream.readUnsignedShort() * 1811727251;
		if (0 != aByte1149)
		    anInt1198 = stream.readUnsignedShort() * 1572578003;
	    }
	    if (type * -1215239439 == 4) {
		anInt1210 = stream.readBigSmart(1235052657) * -2074006897;
		if (i_1_ >= 2)
		    aBoolean1211 = stream.readUnsignedByte() == 1;
		aString1212 = stream.readString(332948556);
		//if (aString1212.toLowerCase().contains("runescape")) {
		//    aString1212 = aString1212.replace("runescape", "CorruptionX - Matrix II");
		//    aString1212 = aString1212.replace("RuneScape", "CorruptionX - Matrix II");
		//    aString1212 = aString1212.replace("Runescape", "CorruptionX - Matrix II");
		//}
		anInt1191 = stream.readUnsignedByte() * 1629063197;
		anInt1214 = stream.readUnsignedByte() * -1733811909;
		anInt1124 = stream.readUnsignedByte() * 210030285;
		aBoolean1216 = stream.readUnsignedByte() == 1;
		anInt1170 = stream.readInt((byte) 30) * -695431873;
		anInt1223 = stream.readUnsignedByte() * 728904583;
		if (i_1_ >= 0)
		    anInt1217 = stream.readUnsignedByte() * -1455284437;
	    }
	    if (3 == -1215239439 * type) {
		anInt1170 = stream.readInt((byte) -80) * -695431873;
		aBoolean1171 = stream.readUnsignedByte() == 1;
		anInt1223 = stream.readUnsignedByte() * 728904583;
	    }
	    if (9 == -1215239439 * type) {
		anInt1173 = stream.readUnsignedByte() * -1041514725;
		anInt1170 = stream.readInt((byte) -33) * -695431873;
		aBoolean1174 = stream.readUnsignedByte() == 1;
	    }
	    int i_5_ = stream.read24BitUnsignedInteger((byte) 8);
	    int i_6_ = stream.readUnsignedByte();
	    if (i_6_ != 0) {
		aByteArray1185 = new byte[11];
		aByteArray1222 = new byte[11];
		anIntArray1276 = new int[11];
		for (/**/; i_6_ != 0; i_6_ = stream.readUnsignedByte()) {
		    int i_7_ = (i_6_ >> 4) - 1;
		    i_6_ = i_6_ << 8 | stream.readUnsignedByte();
		    i_6_ &= 0xfff;
		    if (i_6_ == 4095)
			i_6_ = -1;
		    byte i_8_ = stream.readByte(-12558881);
		    if (i_8_ != 0)
			aBoolean1220 = true;
		    byte i_9_ = stream.readByte(-12558881);
		    anIntArray1276[i_7_] = i_6_;
		    aByteArray1185[i_7_] = i_8_;
		    aByteArray1222[i_7_] = i_9_;
		}
	    }
	    aString1228 = stream.readString(506985626);
		...
		for (int i_13_ = 0; i_13_ < i_11_; i_13_++)
		    aStringArray1195[i_13_] = stream.readString(-1637502084);
	    }
	    if (i_12_ > 0) {
		...
		anIntArray1231[i_14_] = stream.readUnsignedShort();
	    }
	    if (i_12_ > 1) {
		int i_16_ = stream.readUnsignedByte();
		anIntArray1231[i_16_] = stream.readUnsignedShort();
	    }
	    aString1230 = stream.readString(-1953229569);
	    if (aString1230.equals(""))
		aString1230 = null;
	    anInt1239 = stream.readUnsignedByte() * 476443207;
	    anInt1235 = stream.readUnsignedByte() * -978869921;
	    if (client.drag)
		anInt1235 = client.dragValue * -978869921;
	    anInt1236 = stream.readUnsignedByte() * 2138287179;
	    aString1237 = stream.readString(-1171596112);
	    int i_17_ = -1;
	    if (Class68.method784(i_5_, (byte) 111) != 0) {
		i_17_ = stream.readUnsignedShort();
		if (i_17_ == 65535)
		    i_17_ = -1;
		anInt1179 = stream.readUnsignedShort() * 2021607495;
		if (-2051415689 * anInt1179 == 65535)
		    anInt1179 = -2021607495;
		anInt1163 = stream.readUnsignedShort() * 1830595391;
		if (65535 == anInt1163 * -1149188929)
		    anInt1163 = -1830595391;
	    }
	    if (i_1_ >= 0) {
		anInt1272 = stream.readUnsignedShort() * -1122372539;
		if (65535 == -1200030067 * anInt1272)
		    anInt1272 = 1122372539;
	    }
	    aClass298_Sub38_1219 = new Class298_Sub38(i_5_, i_17_);
	    if (i_1_ >= 0) {
		int i_18_ = stream.readUnsignedByte();
		for (int i_19_ = 0; i_19_ < i_18_; i_19_++) {
		    int i_20_ = stream.read24BitUnsignedInteger((byte) 10);
		    int i_21_ = stream.readInt((byte) 29);
		...
		for (int i_23_ = 0; i_23_ < i_22_; i_23_++) {
		    int i_24_ = stream.read24BitUnsignedInteger((byte) 19);
		    String string = stream.readJagString(681479919);
		    this.aClass437_1279.method5817(new Class298_Sub29(string), i_24_);
		}
	    }
	    anObjectArray1257 = method1111(stream, 422796707);
	    anObjectArray1244 = method1111(stream, 1852122968);
	    anObjectArray1122 = method1111(stream, 747815110);
	    anObjectArray1120 = method1111(stream, -1548123654);
	    anObjectArray1249 = method1111(stream, 1097191149);
	    anObjectArray1177 = method1111(stream, 1634014672);
	    ...
	    anObjectArray1243 = method1111(stream, -2041361593);
	    anObjectArray1291 = method1111(stream, 138548004);
	    anObjectArray1137 = method1111(stream, 756814807);
	    anObjectArray1229 = method1111(stream, 22261945);
	    anObjectArray1200 = method1111(stream, -354820234);
	    anObjectArray1157 = method1111(stream, 749663504);
	    anIntArray1188 = method1118(stream, 1930385253);
	    anIntArray1254 = method1118(stream, 1885577185);
	    anIntArray1256 = method1118(stream, 2036299454);
	    anIntArray1258 = method1118(stream, 1866337228);
	    anIntArray1260 = method1118(stream, 1808578494);
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eg.x(").append(')').toString());
	}
    }

    Object[] method1111(RsByteBuffer class298_sub53, int i) {
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eg.r(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eg.s(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eg.z(").append(')').toString());
	}
    }

    public void method1114(GraphicsToolkit class_ra, Class387 class387, Class222 class222, int i, int i_28_) {
	try {
	    class387.method4786(class222);
	    Class85[] class85s = class387.method4781();
	    Class68[] class68s = class387.method4728();
	    if ((null == aClass351_1218 || aClass351_1218.aBoolean3772) && (null != class85s || class68s != null))
		aClass351_1218 = Class351.method4232(i, false);
	    if (aClass351_1218 != null)
		aClass351_1218.method4231(class_ra, i, class85s, class68s, false);
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eg.t(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eg.j(").append(')').toString());
	}
    }

    public Class117 method1116(GraphicsToolkit class_ra, int i) {
	try {
	    long l = ((long) (ihash * -440872681) << 32 | -1309843523 * anInt1154 & 0xffffffffL);
	    Class117 class117 = (Class117) aClass348_1136.method4184(l);
	    if (class117 != null) {
		if (spriteId * 1411971043 != class117.anInt1398 * 1509093479) {
	    ...
	    IndexedImage class89 = IndexedImage.method987(Class124.aClass243_1480, 1411971043 * spriteId, 0);
	    if (null == class89)
		return null;
	    ...
	    if (null == class_ta)
		return null;
	    class117 = new Class117(i_31_, i_32_, is_33_, is, class_ta, 1411971043 * spriteId);
	    aClass348_1136.method4194(class117, l);
	    return class117;
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eg.l(").append(')').toString());
	}
    }
	...
	try {
	    if (null == this.aClass437_1279)
		return i_39_;
	    Class298_Sub35 class298_sub35 = ((Class298_Sub35) this.aClass437_1279.method5812(i));
	    if (class298_sub35 == null)
		return i_39_;
	    return class298_sub35.anInt7394 * -774922497;
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eg.ax(").append(')').toString());
	}
    }

    int[] method1118(RsByteBuffer class298_sub53, int i) {
	try {
		...
		is[i_42_] = class298_sub53.readInt((byte) -23);
	    return is;
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eg.q(").append(')').toString());
	}
    }
	...
	try {
		...
		this.aClass437_1279.method5817(new Class298_Sub29(string), i);
	    } else {
		Class298_Sub29 class298_sub29 = ((Class298_Sub29) this.aClass437_1279.method5812(i));
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eg.ae(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eg.av(").append(')').toString());
	}
    }
	...
	aClass348_1135 = new Class348(3000000, 200);
	aClass348_1136 = new Class348(8);
	aClass348_1296 = new Class348(4);
	aClass348_1138 = new Class348(50);
	aBoolean1139 = false;
    }
	...
	try {
	    ...
	    Class277 class277 = (Class277) aClass348_1296.method4184(l);
	    if (class277 == null) {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eg.h(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eg.w(").append(')').toString());
	}
    }
	...
	try {
		...
		Class298 class298 = this.aClass437_1279.method5812(i);
		if (class298 != null)
		    class298.method2839(-1460969981);
	    }
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eg.ao(").append(')').toString());
	}
    }
	...
	try {
		...
		if (null == class387 || class_ra.method5017(class387.m(), i) != 0) {
			...
			class64.method755(2);
		    class387 = class_ra.method5037(class64, i, Class21.anInt275 * 951783317, 64, 768);
		    if (null != this.aShortArray1118) {
			for (int i_53_ = 0; i_53_ < this.aShortArray1118.length; i_53_++)
			    class387.X((this.aShortArray1118[i_53_]), (this.aShortArray1203[i_53_]));
		    }
		    if (this.aShortArray1204 != null) {
			for (int i_54_ = 0; i_54_ < this.aShortArray1204.length; i_54_++)
			    class387.W((this.aShortArray1204[i_54_]), (this.aShortArray1234[i_54_]));
		    }
		...
		Class387 class387 = (class507.method6269(572201537 * anInt1151, -1438978079).method6237(class_ra, i, interface23, class438, aClass498_1307, 636300802));
		if (null == class387) {
		    aBoolean1139 = true;
		    return null;
		}
		...
		Class387 class387 = class468.method6029(class_ra, i, 10, class366, class438, 0, 0, 0, 0, 2097526071);
		if (null == class387) {
		    aBoolean1139 = true;
		    return null;
		}
		...
		Class387 class387 = (class507.method6269(anInt1151 * 572201537, -2061874989).method6246(class_ra, i, class349, interface23, class438, null, null, null, 0, aClass498_1307, -884053309));
		if (class387 == null) {
		    aBoolean1139 = true;
		    return null;
		}
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eg.y(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eg.ak(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eg.ad(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eg.o(").append(')').toString());
	}
    }
	...
	anInt1217 = 0;
	aBoolean1246 = false;
	aClass298_Sub38_1219 = Class298_Sub38.aClass298_Sub38_7415;
	aBoolean1220 = false;
	aString1228 = "";
	anInt1232 = 7527659;
	aClass105_1233 = null;
	...
	try {
	    aBoolean1139 = false;
	    long l = (((aBoolean1180 ? 1L : 0L) << 38) + (((aBoolean1182 ? 1L : 0L) << 35) + spriteId * 1411971043 + ((long) (anInt1178 * 547522005) << 36)) + ((aBoolean1181 ? 1L : 0L) << 39) + ((long) (anInt1251 * -2065110161) << 40));
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eg.n(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eg.u(").append(')').toString());
	}
    }

    static void method1130(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[class403.anInt5239 * 681479919 - 1] = (Class316.aClass362_3318.method4307((class403.anIntArray5244[class403.anInt5239 * 681479919 - 1]), 245040087).method4563(Class128.aClass148_6331, client.anIntArray8828, (byte) 76)) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eg.m(").append(')').toString());
	}
    }

    static final void method1131(Class403 class403, short i) {
	try {
	    ...
	    Class321.method3925(class105, class119, class403, (byte) -72);
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eg.im(").append(')').toString());
	}
    }
	...
	try {
		...
		class403.myClanChannel = Class350.aClass298_Sub25_3757;
	    } else
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = 0;
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eg.xe(").append(')').toString());
	}
    }

    static final void method1134(Class403 class403, int i) {
	try {
	    int i_68_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    MapDetails class298_sub37_sub13 = Class298_Sub7.method2864(142245824);
	    if (null != class298_sub37_sub13) {
		boolean bool = class298_sub37_sub13.method3451(i_68_ >> 14 & 0x3fff, i_68_ & 0x3fff, Class388.anIntArray4156, -1054516511);
		if (bool) {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eg.aee(").append(')').toString());
	}
    }

    static final void method1135(Class365_Sub1 class365_sub1, Class403 class403, int i) {
	try {
	    boolean bool = false;
	    int i_69_ = 0;
	    int i_70_ = 0;
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eg.apj(").append(')').toString());
	}
    }
	...
	try {
	    ...
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("eg.d(").append(')').toString());
	}
    }
}
