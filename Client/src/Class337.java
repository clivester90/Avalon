...
public class Class337 {
    ...
    static final void method4109(Class403 class403, int i) {
	try {
	    ...
	    Integer integer = (class403.aClass162_5252.method1754((client.gametype.gameType * -937307905 << 16 | class376.anInt4086 * -1808461691), class376.anInt4087 * -2047408817, class376.anInt4088 * -530058953, -1943222730));
    ...
    static final void method4110(Class403 class403, byte i) {
	try {
    ...
    static final void method4111(Class403 class403, byte i) {
	try {
    ...
    static final void method4112(Class403 class403, int i) {
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = class468.aBoolean5771 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
