...
public class Class254 {
	...
	try {
	    ...
	    int i_2_ = (class403.anIntArray5244[class403.anInt5239 * 681479919 + 2]);
	    if (i_1_ == -1)
	...
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class364.method4334((char) i_3_, -401787251) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    class403.anInt5241 -= -1386882043;
	    Class23.method377((String) (class403.anObjectArray5240[class403.anInt5241 * -203050393]), (String) (class403.anObjectArray5240[1 + -203050393 * class403.anInt5241]), (String) (class403.anObjectArray5240[-203050393 * class403.anInt5241 + 2]), (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]) == 1, true, (byte) -43);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class459.method5977((byte) 79).getType(694163818);
	}
	catch (RuntimeException runtimeexception) {
