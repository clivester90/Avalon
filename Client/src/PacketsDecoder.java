...
public class PacketsDecoder {
    ...
    static final boolean method4548(Class25 class25, int i) throws IOException {
        try {
            ...
            RsBitsBuffer stream = class25.aClass298_Sub53_Sub2_333;
            if (class318 == null)
                return false;
            if (null == class25.INCOMMING_PACKET) {
                if (class25.aBoolean337) {
                    if (!class318.isAvailable(1, (byte) -44))
                        return false;
                    class318.readBytes((class25.aClass298_Sub53_Sub2_333.buffer), 0, 1, (byte) 1);
                    class25.anInt341 += 655103753;
                    class25.anInt338 = 0;
                    class25.aBoolean337 = false;
                }
                stream.index = 0;
                if (stream.method3661((byte) -78)) {
                    if (!class318.isAvailable(1, (byte) -13))
                        return false;
                    class318.readBytes((class25.aClass298_Sub53_Sub2_333.buffer), 1, 1, (byte) 4);
                    class25.anInt341 += 655103753;
                    class25.anInt338 = 0;
                }
                class25.aBoolean337 = true;
                ...
                class25.INCOMMING_PACKET = class202s[i_78_];
                class25.anInt336 = class25.INCOMMING_PACKET.anInt2165 * -80186869;
            }
            if (-1 == -866602563 * class25.anInt336) {
                if (!class318.isAvailable(1, (byte) -5))
                    return false;
                class318.readBytes(stream.buffer, 0, 1, (byte) 48);
                class25.anInt336 = ((stream.buffer[0] & 0xff) * -1265692267);
                class25.anInt341 += 655103753;
                class25.anInt338 = 0;
            }
            if (-2 == -866602563 * class25.anInt336) {
                if (!class318.isAvailable(2, (byte) 9))
                    return false;
                class318.readBytes(stream.buffer, 0, 2, (byte) -84);
                stream.index = 0;
                class25.anInt336 = stream.readUnsignedShort() * -1265692267;
                class25.anInt341 += 1310207506;
                class25.anInt338 = 0;
            }
            if (-866602563 * class25.anInt336 > 0) {
                if (!class318.isAvailable((-866602563 * class25.anInt336), (byte) -53))
                    return false;
                stream.index = 0;
                class318.readBytes(stream.buffer, 0, -866602563 * class25.anInt336, (byte) 117);
                class25.anInt341 += 1190279845 * class25.anInt336;
                class25.anInt338 = 0;
            }
            class25.aClass202_348 = class25.aClass202_345;
            class25.aClass202_345 = class25.aClass202_344;
            class25.aClass202_344 = class25.INCOMMING_PACKET;
            if (class25.INCOMMING_PACKET == IncommingPacket.aClass202_2162) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.aClass202_2261) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.SYSTEM_TRAY_MESSAGE_PACKET) {
                String message = stream.readString(i);
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.aClass202_2255) {
                int i_79_ = stream.readUnsignedShort();
                Class321.method3928(i_79_, (byte) 1);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (IncommingPacket.MESSAGE_PACKET == class25.INCOMMING_PACKET) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.aClass202_2309) {
                client.anInt8845 = stream.readShort(2135181158) * 2043410797;
                client.anInt8888 = client.anInt8933 * 1991119277;
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (class25.INCOMMING_PACKET == IncommingPacket.KEEP_ALIVE_PACKET) {
                class25.INCOMMING_PACKET = null;
                return false;
            }
            if (class25.INCOMMING_PACKET == IncommingPacket.NPC_ON_ICOMPONENT_PACKET) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.CUSTOM_PACKET_161) {
                int flag = stream.readUnsignedByte();
                client.shiftDrop = (flag & 0x1) != 0;
                client.drag = (flag & 0x2) != 0;
                boolean clientZoom = (flag & 0x4) != 0;
                if (clientZoom != client.Zoom) {
                    client.zoomValue = 256;
                    Class305.method3752(184, client.zoomValue, 644551429);
                    client.Zoom = (flag & 0x4) != 0;
                }
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (class25.INCOMMING_PACKET == IncommingPacket.DEVELOPER_PACKET) {
                ...
                if (developerMode != client.developerMode) {
                    client.developerMode = (flag & 0x1) != 0;
                }
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (IncommingPacket.aClass202_2277 == class25.INCOMMING_PACKET) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.aClass202_2209) {
            ...
            if (IncommingPacket.aClass202_2270 == class25.INCOMMING_PACKET) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.aClass202_2204) {
                Class313.anObjectArray3298 = null;
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (class25.INCOMMING_PACKET == IncommingPacket.GRAPHICS_PACKET) {
                ...
                if (targetHash >> 30 != 0) {
                    ...
                    if (i_102_ >= 0 && i_103_ >= 0 && (i_102_ < client.aClass283_8716.method2629(-1990296889)) && (i_103_ < client.aClass283_8716.method2630(-1604198619))) {
                        if (graphicsId == -1) {
                            Class298_Sub37_Sub3 class298_sub37_sub3 = ((Class298_Sub37_Sub3) (client.aClass437_8825.method5812(i_102_ << 16 | i_103_)));
                            ...
                            client.aClass437_8825.method5817((new Class298_Sub37_Sub3(class365_sub1_sub1_sub3)), i_102_ << 16 | i_103_);
                        }
                    }
            ...
            if (IncommingPacket.OPEN_INTERFACE_OBJECT == class25.INCOMMING_PACKET) {
            ...
            if (IncommingPacket.aClass202_2186 == class25.INCOMMING_PACKET) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.PRIVATE_GAME_BAR_STAGE_PACKET) {
                Class110.aClass459_6404 = Class275.method2571(stream.readUnsignedByte(), 413652738);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (IncommingPacket.GLOBAL_STRING_PACKET_2 == class25.INCOMMING_PACKET) {
            ...
            if (IncommingPacket.aClass202_2182 == class25.INCOMMING_PACKET) {
                Class315.method3834(SubIncommingPacket.aClass206_2347, (short) -69);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (IncommingPacket.CONFIG1_PACKET == class25.INCOMMING_PACKET) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.aClass202_2166) {
                Class128.aClass148_6331.method1603(-1701505848);
                client.anInt8783 += -612656928;
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (IncommingPacket.aClass202_2199 == class25.INCOMMING_PACKET) {
                ...
                if (bool_139_) {
                    ...
                    class7.aString94 = Class173.method1824(class7.aString93, -514633017);
                    ...
                    for (i_143_ = -1801543887 * Class489.anInt6071 - 1; i_143_ >= 0; i_143_--) {
                        int i_144_ = Class82_Sub6.aClass7Array6846[i_143_].aString94.compareTo(class7.aString94);
                        if (0 == i_144_) {
            ...
            if (IncommingPacket.SYSTEM_UPDATE_PACKET == class25.INCOMMING_PACKET) {
                if (Class299.method3682(client.anInt8752 * -1233866115, 1765230881))
                    client.anInt8669 = (int) (stream.readUnsignedShort() * 2.5F) * -2090750423;
                else
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.CLAN_CHANNEL_PACKET) {
                client.anInt8886 = -1469951735 * client.anInt8933;
                boolean bool = stream.readUnsignedByte() == 1;
                if (class25.anInt336 * -866602563 == 1) {
                    if (bool)
                ...
                if (bool)
                    Class350.aClass298_Sub25_3757 = new ClanChannel(stream);
                else
                    Class375.aClass298_Sub25_4084 = new ClanChannel(stream);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (IncommingPacket.aClass202_2237 == class25.INCOMMING_PACKET) {
            ...
            if (IncommingPacket.aClass202_2184 == class25.INCOMMING_PACKET) {
            ...
            if (IncommingPacket.aClass202_2307 == class25.INCOMMING_PACKET) {
            ...
            if (IncommingPacket.ICOMPONENT_MODEL_PACKET == class25.INCOMMING_PACKET) {
                int i_154_ = stream.readIntV1(1989852233);
                int i_155_ = stream.readIntV1(1846064867);
                Class343.method4162(1511078955);
                SubIncommingPacket.sendSomethingOnIComponent(i_155_, i_154_, 1, -1, 262144);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (class25.INCOMMING_PACKET == IncommingPacket.aClass202_2236) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.aClass202_2177) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.SET_MOUSE_PACKET) {
                Class82_Sub6.aString6845 = (-866602563 * class25.anInt336 > 2 ? stream.readString(-1124509361) : Tradution.aClass470_5854.method6049(Class321.aClass429_3357, -875414210));
                client.anInt8822 = ((class25.anInt336 * -866602563 > 0 ? stream.readUnsignedShort() : -1) * 812630591);
                if (client.anInt8822 * -1471730241 == 65535)
                    client.anInt8822 = -812630591;
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (IncommingPacket.aClass202_2160 == class25.INCOMMING_PACKET) {
                ...
                Class113.method1254(parenthash, new Class298_Sub51_Sub4(i_165_, idk, new Class400(class341, i_162_)), new int[]{key1, key2, key3, key4}, false);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (IncommingPacket.aClass202_2153 == class25.INCOMMING_PACKET) {
                boolean bool = stream.readUnsignedByte() == 1;
                String string = stream.readString(1064239302);
                long l = stream.readUnsignedShort();
                long l_166_ = stream.read24BitUnsignedInteger((byte) -89);
                int i_167_ = stream.readUnsignedByte();
                long l_168_ = (l << 32) + l_166_;
                boolean bool_169_ = false;
                ClanChannel class298_sub25 = (bool ? Class350.aClass298_Sub25_3757 : Class375.aClass298_Sub25_4084);
                while_86_:
                do {
                ...
                if (!bool_169_) {
                    ...
                    if (2 == i_167_ || i_167_ == 3)
                        Class25.method393(i_172_, 0, "<img=" + i_167_ + ">" + new StringBuilder().append(Class247.method2368(1, -278777595)).append(string).toString(), "<img=" + i_167_ + ">" + new StringBuilder().append(Class247.method2368(1, -278777595)).append(string).toString(), string, string_171_, class298_sub25.aString7358, -1, 1446000206);
                    else if (i_167_ == 1)
                        Class25.method393(i_172_, 0, "<img=" + i_167_ + ">" + new StringBuilder().append(Class247.method2368(0, -278777595)).append(string).toString(), "<img=" + i_167_ + ">" + new StringBuilder().append(Class247.method2368(0, -278777595)).append(string).toString(), string, string_171_, class298_sub25.aString7358, -1, 1446000206);
                    else
            ...
            if (IncommingPacket.ICOMPONENT_SETTINGS_PACKET == class25.INCOMMING_PACKET) {
            ...
            if (IncommingPacket.aClass202_2223 == class25.INCOMMING_PACKET) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.CONFIG_BY_FILE2_PACKET) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.aClass202_2274) {//possible
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.aClass202_2193) {
                Class315.method3834(SubIncommingPacket.aClass206_2354, (short) 16643);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (class25.INCOMMING_PACKET == IncommingPacket.OBJECT_ANIMATION_PACKET) {
            ...
            if (IncommingPacket.PUBLIC_MESSAGE_PACKET == class25.INCOMMING_PACKET) {
                ...
                if (null != class365_sub1_sub1_sub2_sub2.aString10195 && null != class365_sub1_sub1_sub2_sub2.aClass366_10209) {
                    ...
                    if (!bool_201_) {
                        ...
                        if (rights == 2)
                            ...
                            Class25.method393(i_203_, 0, "<img=" + rights + ">" + class365_sub1_sub1_sub2_sub2.method4470(true, -1755073777), "<img=" + rights + ">" + class365_sub1_sub1_sub2_sub2.method4475(false, (byte) -103), class365_sub1_sub1_sub2_sub2.aString10200, string, null, i_202_, 1446000206);
                        else
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.aClass202_2212) {
            ...
            if (IncommingPacket.RUN_ENERGY_PACKET == class25.INCOMMING_PACKET) {
                client.anInt8844 = stream.readUnsignedByte() * -1985989501;
                client.anInt8888 = client.anInt8933 * 1991119277;
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (class25.INCOMMING_PACKET == IncommingPacket.PLAYER_OPTION_PACKET) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.ITEMS_PACKET) {
            ...
            if (IncommingPacket.RECEIVE_PRIVATE_QUICK_CHAT_MESSAGE_PACKET == class25.INCOMMING_PACKET) {
                ...
                long l = stream.readUnsignedShort();
                long l_234_ = stream.read24BitUnsignedInteger((byte) -47);
                int rights = stream.readUnsignedByte();
                ...
                if (!bool_238_) {
                    ...
                    if (2 == rights)
                        ...
                        Class25.method393(18, 0, "<img=" + rights + ">" + string, "<img=" + rights + ">" + string_233_, string, string_240_, null, i_236_, 1446000206);
                    else
            ...
            if (IncommingPacket.aClass202_2259 == class25.INCOMMING_PACKET) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.aClass202_2293) {
            ...
            if (IncommingPacket.aClass202_2249 == class25.INCOMMING_PACKET) {
            ...
            if (IncommingPacket.aClass202_2276 == class25.INCOMMING_PACKET) {
                ClanSettings.baseTileX = (stream.readByteC(169252362) << 3) * 1536927433;
                Class375.basePlane = stream.readUnsignedByte() * -1217120325;
                Class216.baseTileY = ((stream.readByteC(-136295651) << 3) * 2091861441);
                while (385051775 * stream.index < class25.anInt336 * -866602563) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.aClass202_2248) {
            ...
            if (IncommingPacket.MUSIC_PACKET == class25.INCOMMING_PACKET) {
                int delay = stream.readUnsignedByte();
                int i_252_ = stream.readUnsignedShortLE128(1478539457);
                if (i_252_ == 65535)
                    i_252_ = -1;
                int volume = stream.readUnsignedByte128(-1014855659);
                Class86.method967(i_252_, volume, delay, 1756237267);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (IncommingPacket.SHAKE_CAMERA_PACKET == class25.INCOMMING_PACKET) {
                int c = stream.readUnsignedByte128(-1014855659);
                int slotId = stream.readUnsignedByte128(-1014855659);
                int b = stream.readUnsignedByte128(-1014855659);
                int a = stream.readUnsignedByte128(-1014855659);
                int d = stream.readUnsignedShortLE((byte) 49);
                Class343.method4162(1754985057);
                client.aBooleanArray8684[slotId] = true;
                client.anIntArray8860[slotId] = a;
                client.anIntArray8925[slotId] = b;
                client.anIntArray8926[slotId] = c;
                client.anIntArray8790[slotId] = d;
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (IncommingPacket.aClass202_2195 == class25.INCOMMING_PACKET) {
            ...
            if (IncommingPacket.RECEIVE_FRIEND_CHAT_QUICK_MESSAGE_PACKET == class25.INCOMMING_PACKET) {
                boolean bool = stream.readUnsignedByte() == 1;
                ...
                long l_261_ = stream.readUnsignedShort();
                long l_262_ = stream.read24BitUnsignedInteger((byte) 50);
                int rights = stream.readUnsignedByte();
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.aClass202_2242) {
                boolean bool = stream.readUnsignedByte() == 1;
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.FRIENDS_PACKET) {
                while (stream.index * 385051775 < class25.anInt336 * -866602563) {
                    boolean bool = stream.readUnsignedByte() == 1;
                    String string = stream.readString(1159315726);
                    String string_269_ = stream.readString(1988455124);
                    int worldId = stream.readUnsignedShort();
                    ...
                    for (int i_275_ = 0; i_275_ < client.anInt8941 * -1054937867; i_275_++) {
                        if (!bool) {
                            if (string.equals(client.aStringArray8704[i_275_])) {
                                if (client.anIntArray8946[i_275_] != worldId) {
                                    ...
                                    for (Class302_Sub2 class302_sub2 = ((Class302_Sub2) client.aClass442_8951.method5868(-16777216)); null != class302_sub2; class302_sub2 = ((Class302_Sub2) client.aClass442_8951.method5872(269965941))) {
                                        if (class302_sub2.aString7648.equals(string)) {
                                            if (worldId != 0 && (class302_sub2.aShort7646 == 0)) {
                                                class302_sub2.method3714(185516853);
                                                bool_276_ = false;
                                            } else if (worldId == 0 && (0 != (class302_sub2.aShort7646))) {
                                    ...
                                    if (bool_276_)
                                        client.aClass442_8951.method5870(new Class302_Sub2(string, worldId), 1940667363);
                                    client.anIntArray8946[i_275_] = worldId;
                                }
                    ...
                    if (string != null && client.anInt8941 * -1054937867 < 200) {
                        ...
                        client.anIntArray8946[-1054937867 * client.anInt8941] = worldId;
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.CLAN_SETTINGS_PACKET) {
                client.anInt8885 = 887090299 * client.anInt8933;
                boolean bool = stream.readUnsignedByte() == 1;
                if (-866602563 * class25.anInt336 == 1) {
                    if (bool)
                ...
                if (bool)
                    Class225.aClass162_2512 = new ClanSettings(stream);
                else
                    Class508.aClass162_6216 = new ClanSettings(stream);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (IncommingPacket.SPAWN_OBJECT_PACKET == class25.INCOMMING_PACKET) {
                Class315.method3834(SubIncommingPacket.SPAWN_OBJECT_PACKET, (short) -2213);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (class25.INCOMMING_PACKET == IncommingPacket.SET_CAMERA_POS_PACKET) {
            ...
            if (IncommingPacket.aClass202_2228 == class25.INCOMMING_PACKET) {
                if (-1 != client.WINDOW_PANE_ID * -257444687)
                    Class82_Sub10.method903(client.WINDOW_PANE_ID * -257444687, 0, 390245730);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (IncommingPacket.aClass202_2198 == class25.INCOMMING_PACKET) {
            ...
            if (IncommingPacket.OPEN_INTERFACE_NPC == class25.INCOMMING_PACKET) {
                ...
                Class113.method1254(parentHash, new Class298_Sub51_Sub2(interfaceId, cliped, npcIndex), new int[]{key1, key2, key3, key4}, false);

                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (class25.INCOMMING_PACKET == IncommingPacket.OTHER_GAME_BAR_STAGES_PACKET) {
            ...
            // not
            if (IncommingPacket.aClass202_2267 == class25.INCOMMING_PACKET) {
                ...
                SubIncommingPacket.sendSomethingOnIComponent(interfaceHash, i_300_, 5, i_302_, 262144);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (IncommingPacket.CAMERA_ROTATION_PACKET == class25.INCOMMING_PACKET) {
                int y = stream.readUnsignedShort();
                int x = stream.readUnsignedShortLE((byte) -3);
                Class343.method4162(2073286157);
                Class344.method4165(x, y, 0, -1627127168);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (class25.INCOMMING_PACKET == IncommingPacket.SEND_PRIVATE_MESSAGE_PACKET) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.SEND_PRIVATE_QUICK_CHAT_MESSAGE_PACKET) {
            ...
            if (IncommingPacket.aClass202_2299 == class25.INCOMMING_PACKET) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.GLOBAL_CONFIG2_PACKET) {
            ...
            if (IncommingPacket.aClass202_2201 == class25.INCOMMING_PACKET) {
            ...
            if (IncommingPacket.CONFIG_BY_FILE1_PACKET == class25.INCOMMING_PACKET) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.aClass202_2251) {
                int i_315_ = stream.readInt((byte) 69);
                int i_316_ = stream.readInt((byte) -11);
                Class343.method4162(1838306305);
                Interface class298_sub51 = ((Interface) client.aClass437_8841.method5812(i_315_));
                Interface class298_sub51_317_ = ((Interface) client.aClass437_8841.method5812(i_316_));
                ...
                if (class298_sub51 != null) {
                    ...
                    client.aClass437_8841.method5817(class298_sub51, i_316_);
                }
                ...
                if (class105 != null) {
                    ...
                    Class65.method761((Class389.aClass119Array4165[(-440872681 * class105.ihash >>> 16)]), class105, true, 112223880);
                }
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.TILE_MESSAGE_PACKET) {
                Class315.method3834(SubIncommingPacket.TILE_MESSAGE_PACKET, (short) 15563);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (IncommingPacket.MUSIC_EFFECT_PACKET == class25.INCOMMING_PACKET) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.GAME_PANE_PACKET) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.INDEX14_SOUND_PACKET) {
                int id = stream.readUnsignedShort();
                if (65535 == id)
                    id = -1;
                int repeatAmt = stream.readUnsignedByte();
                int delay = stream.readUnsignedShort();
                int value255 = stream.readUnsignedByte();
                int value256 = stream.readUnsignedShort();
                Class239.method2210(id, repeatAmt, delay, value255, value256, 1530382732);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (class25.INCOMMING_PACKET == IncommingPacket.ITEMS_UPDATE_PACKET) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.aClass202_2230) {
            ...
            if (IncommingPacket.GLOBAL_CONFIG1_PACKET == class25.INCOMMING_PACKET) {
            ...
            if (IncommingPacket.aClass202_2250 == class25.INCOMMING_PACKET) {
                int i_342_ = stream.readInt((byte) -66);
                Class343.method4162(1629324419);
                SubIncommingPacket.sendSomethingOnIComponent(i_342_, client.playerIndex * -442628795, 5, 0, 262144);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (class25.INCOMMING_PACKET == IncommingPacket.PLAYER_UNDER_NPC_PRIORITY_PACKET) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.aClass202_2172) {
                ...
                Shortcut.method4265(i_344_, i_347_, i_345_, i_346_);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (IncommingPacket.aClass202_2290 == class25.INCOMMING_PACKET) {
            ...
            if (IncommingPacket.RESET_SOUNDS_PACKET == class25.INCOMMING_PACKET) {
                Class422.resetSounds((byte) -98);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (IncommingPacket.RECEIVE_PERSONAL_MESSAGE_PACKET == class25.INCOMMING_PACKET) {
                boolean bool = stream.readUnsignedByte() == 1;
            ...
            if (IncommingPacket.NPC_UPDATE_PACKET == class25.INCOMMING_PACKET) {
                Class406.decodeNPCUpdate(false, -1542019143);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (class25.INCOMMING_PACKET == IncommingPacket.aClass202_2272) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.aClass202_2168) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.LOGOUT_PACKET) {
                Class216.method2001(false, (byte) 107);
                class25.INCOMMING_PACKET = null;
                return false;
            }
            if (IncommingPacket.aClass202_2179 == class25.INCOMMING_PACKET) {
            ...
            if (IncommingPacket.aClass202_2297 == class25.INCOMMING_PACKET) {
                client.aBoolean8815 = stream.readUnsignedByteC((short) -6905) == 1;
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (IncommingPacket.aClass202_2221 == class25.INCOMMING_PACKET) {
            ...
            if (IncommingPacket.SEND_GROUND_ITEM_PACKET == class25.INCOMMING_PACKET) {
                Class315.method3834(SubIncommingPacket.SEND_GROUND_ITEM_PACKET, (short) 18993);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (IncommingPacket.CUTSCENE_PACKET == class25.INCOMMING_PACKET) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.DESTROY_OBJECT_PACKET) {
                Class315.method3834(SubIncommingPacket.DESTROY_OBJECT_PACKET, (short) -19172);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (IncommingPacket.aClass202_2203 == class25.INCOMMING_PACKET) {
                int slot = stream.readUnsignedByte();
                if (stream.readUnsignedByte() == 0)
                    client.GRAND_EXCHANGE_SLOTS[slot] = new Class251();
                else {
                    stream.index -= 116413311;
                    client.GRAND_EXCHANGE_SLOTS[slot] = new Class251(stream);
                }
                client.anInt8796 = client.anInt8933 * 1729482221;
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (class25.INCOMMING_PACKET == IncommingPacket.ITEM_ON_ICOMPONENT_PACKET) {
                int itemId = stream.readUnsignedShort128(-666448295);
                if (65535 == itemId)
                    itemId = -1;
                int itemAmount = stream.readIntV1(-731950816);
                byte size = stream.readByte(-1);
                int interfaceId = stream.readIntV2((byte) 47);
                //int modelSize = (int) size;
                Class343.method4162(1742484303);
                RsByteBuffer.showItemOnInterface(interfaceId, itemId, itemAmount);
                ItemDefinitions itemdef = Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(itemId);
                Shortcut.method4265(interfaceId, 330519029 * itemdef.anInt5714, -3355859 * itemdef.anInt5715, itemdef.modelSize * 1396167403);
                Class253.positionComponentOnInterface(interfaceId, 0, -1811316489 * itemdef.anInt5718, 0, 499708204);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (IncommingPacket.aClass202_2191 == class25.INCOMMING_PACKET) {
            ...
            if (IncommingPacket.aClass202_2231 == class25.INCOMMING_PACKET) {
                Class315.method3834(SubIncommingPacket.aClass206_2346, (short) 9490);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (IncommingPacket.aClass202_2284 == class25.INCOMMING_PACKET) {
                Class315.method3834(SubIncommingPacket.aClass206_2357, (short) 18359);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (class25.INCOMMING_PACKET == IncommingPacket.ICOMPONENT_SPRITE_PACKET) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.CLIENT_CONSOLE_COMMAND_PACKET) {
                String string = stream.readString(1645493685);
                Class419.method5605(string, false, false, 1722466628);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (IncommingPacket.ICOMPONENT_TEXT_PACKET == class25.INCOMMING_PACKET) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.RECEIVE_QUICK_PRIVATE_MESSAGE) {
                boolean bool = stream.readUnsignedByte() == 1;
                String string = stream.readString(-247712899);
                long l = stream.readUnsignedShort();
                long l_394_ = stream.read24BitUnsignedInteger((byte) -13);
                int rights = stream.readUnsignedByte();
            ...
            if (IncommingPacket.aClass202_2174 == class25.INCOMMING_PACKET) {
                boolean bool = stream.readUnsignedByte() == 1;
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.INDEX15_SOUND_PACKET) {
                int soundId = stream.readUnsignedShort();
                if (soundId == 65535)
                    soundId = -1;
                int repeatAmt = stream.readUnsignedByte();
                ...
                Class320.method3913(soundId, repeatAmt, delay, volume, true, 256, 2006173434);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (IncommingPacket.aClass202_2305 == class25.INCOMMING_PACKET) {
                Class315.method3834(SubIncommingPacket.aClass206_2356, (short) -5340);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (class25.INCOMMING_PACKET == IncommingPacket.aClass202_2163) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.REMOVE_GROUND_ITEM_PACKET) {
                Class315.method3834(SubIncommingPacket.REMOVE_GROUND_ITEM_PACKET, (short) 8251);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (class25.INCOMMING_PACKET == IncommingPacket.aClass202_2232) {
                ...
                class298_sub36.out.write128Byte(914379507 * Class291.anInt6467, (byte) 1);
                class298_sub36.out.writeInt(i_413_, 390381879);
                class298_sub36.out.writeIntV1(i_414_, (byte) -42);
                class25.method390(class298_sub36, (byte) -114);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (IncommingPacket.OPEN_INTERFACE_PLAYER == class25.INCOMMING_PACKET) {// interface
                // defs?
                ...
                Class113.method1254(parentHash, new Class298_Sub51_Sub1(interfaceId, clipped, index), new int[]{firstXtea, secondXtea, thirdXtea, fourthXtea}, false);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (IncommingPacket.SECURITY_PACKET == class25.INCOMMING_PACKET) {
                Class273.method2566(stream, class25.anInt336 * -866602563, (byte) -111);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (class25.INCOMMING_PACKET == IncommingPacket.aClass202_2154) {// emote
            ...
            if (IncommingPacket.aClass202_2220 == class25.INCOMMING_PACKET) {
                ...
                ClanSettings.baseTileX = (stream.readByteC(188175247) << 3) * 1536927433;
                Class341 class341 = client.aClass283_8716.method2628(681479919);
                for (Class298_Sub2 class298_sub2 = ((Class298_Sub2) client.aClass437_8685.method5816(1564654282)); class298_sub2 != null; class298_sub2 = ((Class298_Sub2) client.aClass437_8685.method5815((byte) 10))) {
                    int i_426_ = (int) ((class298_sub2.hash * 7051297995265073167L) >> 28 & 0x3L);
                    int i_427_ = (int) (7051297995265073167L * class298_sub2.hash & 0x3fffL);
                    int i_428_ = i_427_ - -1760580017 * class341.gameSceneBaseX;
                    int i_429_ = (int) ((7051297995265073167L * class298_sub2.hash) >> 14 & 0x3fffL);
                    int i_430_ = i_429_ - 283514611 * class341.gameSceneBaseY;
                    if (i_426_ == Class375.basePlane * -191892109 && i_428_ >= 134435705 * ClanSettings.baseTileX && i_428_ < 8 + 134435705 * ClanSettings.baseTileX && i_430_ >= -105526719 * Class216.baseTileY && i_430_ < 8 + Class216.baseTileY * -105526719) {
                ...
                for (Class298_Sub1 class298_sub1 = (Class298_Sub1) Class298_Sub1.aClass453_7152.method5939(1766612795); class298_sub1 != null; class298_sub1 = ((Class298_Sub1) Class298_Sub1.aClass453_7152.method5944(49146))) {
                    if ((class298_sub1.anInt7150 * 634196087 >= 134435705 * ClanSettings.baseTileX) && (634196087 * class298_sub1.anInt7150 < 8 + 134435705 * ClanSettings.baseTileX) && (-2146829167 * class298_sub1.anInt7155 >= -105526719 * Class216.baseTileY) && (-2146829167 * class298_sub1.anInt7155 < Class216.baseTileY * -105526719 + 8) && (class298_sub1.anInt7151 * 2108312995) == -191892109 * Class375.basePlane)
                        class298_sub1.aBoolean7160 = true;
                }
                for (Class298_Sub1 class298_sub1 = (Class298_Sub1) Class298_Sub1.aClass453_7162.method5939(1766612795); null != class298_sub1; class298_sub1 = ((Class298_Sub1) Class298_Sub1.aClass453_7162.method5944(49146))) {
                    if ((634196087 * class298_sub1.anInt7150 >= 134435705 * ClanSettings.baseTileX) && (634196087 * class298_sub1.anInt7150 < ClanSettings.baseTileX * 134435705 + 8) && (class298_sub1.anInt7155 * -2146829167 >= -105526719 * Class216.baseTileY) && (class298_sub1.anInt7155 * -2146829167 < -105526719 * Class216.baseTileY + 8) && ((2108312995 * class298_sub1.anInt7151) == -191892109 * Class375.basePlane))
                        class298_sub1.aBoolean7160 = true;
                }
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (IncommingPacket.GLOBAL_STRING_PACKET == class25.INCOMMING_PACKET) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.STOP_CAMERA_SHAKE_PACKET) {
                Class343.method4162(1929183255);
                Class82_Sub11.method906(-1060675118);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (class25.INCOMMING_PACKET == IncommingPacket.aClass202_2227) {
            ...
            if (IncommingPacket.WORLD_TILE_PACKET == class25.INCOMMING_PACKET) {
                ...
                ClanSettings.baseTileX = ((stream.read128Byte(-1150117384) << 3) * 1536927433);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (class25.INCOMMING_PACKET == IncommingPacket.aClass202_2188) {
            ...
            if (IncommingPacket.aClass202_2158 == class25.INCOMMING_PACKET) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.SKILL_LEVEL_PACKET) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.FRIENDS_CHAT_CHANNEL_PACKET) {
                client.anInt8912 = 1348241137 * client.anInt8933;
                if (class25.anInt336 * -866602563 == 0) {
                ...
                for (int i_446_ = 0; i_446_ < Class489.anInt6071 * -1801543887; i_446_++) {
                    ...
                    class7s[i_446_].aString94 = Class173.method1824(class7s[i_446_].aString93, 445649895);
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.LARGE_NPC_UPDATE_PACKET) {
                Class406.decodeNPCUpdate(true, -1463103982);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (class25.INCOMMING_PACKET == IncommingPacket.RESET_CAMERA_PACKET) {
                Class343.method4162(1464854077);
                Class_na.method3478(-2144902476);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (class25.INCOMMING_PACKET == IncommingPacket.HINT_ICON_PACKET) {
                ...
                if (class19.anInt258 * -92466201 >= 0 && (class19.anInt258 * -92466201 < Class128_Sub2.aClass57Array8560.length)) {
                    if (class19.anInt266 * 958933333 == 1 || 10 == class19.anInt266 * 958933333) {
                        ...
                        class19.anInt259 = (stream.readUnsignedByte() * -1962848411);
                        Class341 class341 = client.aClass283_8716.method2628(681479919);
                        ...
                        class19.anInt262 = ((stream.readUnsignedByte() << 2) * -2098711205);
            ...
            if (IncommingPacket.PLAYER_ON_ICOMPONENT_PACKET == class25.INCOMMING_PACKET) {
                int i_453_ = stream.readIntV2((byte) 99);
                Class343.method4162(1945510464);
                SubIncommingPacket.sendSomethingOnIComponent(i_453_, client.playerIndex * -442628795, 3, 0, 262144);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (class25.INCOMMING_PACKET == IncommingPacket.BLACK_OUT_PACKET) {
                Class3.anInt56 = stream.readUnsignedByte() * -986054733;
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (IncommingPacket.aClass202_2247 == class25.INCOMMING_PACKET) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.LOAD_MAP_SCENE_DYNAMIC_PACKET) {
                RsBitsBuffer class298_sub53_sub2_455_ = new RsBitsBuffer(class25.anInt336 * -866602563);
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.aClass202_2306) {
            ...
            if (IncommingPacket.aClass202_2194 == class25.INCOMMING_PACKET) {
            ...
            if (IncommingPacket.aClass202_2215 == class25.INCOMMING_PACKET) {
                Class315.method3834(SubIncommingPacket.aClass206_2343, (short) 17513);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (IncommingPacket.aClass202_2287 == class25.INCOMMING_PACKET) {
                Class315.method3834(SubIncommingPacket.aClass206_2348, (short) 10101);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (class25.INCOMMING_PACKET == IncommingPacket.OPEN_URL_PACKET) {
                if (Class452.aBoolean5642 && Class231.aFrame2589 != null)
                ...
                boolean bool = stream.readUnsignedByte() == 1;
                stream.method3662(is, 0, (class25.anInt336 * -866602563) - 1, (byte) 1);
                RsByteBuffer class298_sub53 = new RsByteBuffer(is);
                String url = class298_sub53.readString(799488751);
                if (bool) {
                    String string_466_ = class298_sub53.readString(403182631);
                    if (string_466_.length() == 0)
                        string_466_ = url;
                    if (!client.aBoolean8638 || Class82_Sub8.aString6856.startsWith("mac") || !Class65.method762(url, 1, Class212.aClass212_2424.method1951(-1209858466), -1999887910))
                    ...
                    Class346.method4172(url, true, Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7571.method5677(-389602471) == 5, client.aBoolean8867, client.aBoolean8651, (byte) 54);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (class25.INCOMMING_PACKET == IncommingPacket.CONFIG2_PACKET) {
            ...
            if (IncommingPacket.aClass202_2238 == class25.INCOMMING_PACKET) {
                int i_469_ = stream.readUnsignedShortLE((byte) -12);
                int i_470_ = stream.readUnsignedShort128(-382838124);
                int ihash = stream.readIntV1(1708571253);
                int i_472_ = stream.readUnsignedShort();
                Class343.method4162(1927580267);
                SubIncommingPacket.sendSomethingOnIComponent(ihash, i_470_ << 16 | i_469_, 7, i_472_, 262144);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (IncommingPacket.PLAYER_UPDATE_PACKET == class25.INCOMMING_PACKET) {
                Class247.decodePlayerUpdate(stream, class25.anInt336 * -866602563, 1110385787);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (IncommingPacket.PROJECTILE_PACKET == class25.INCOMMING_PACKET) {
                Class315.method3834(SubIncommingPacket.PROJECTILE_PACKET, (short) -13236);
                class25.INCOMMING_PACKET = null;
                return true;
            }
            if (IncommingPacket.RECEIVE_FRIEND_CHAT_MESSAGE_PACKET == class25.INCOMMING_PACKET) {
                boolean bool = stream.readUnsignedByte() == 1;
                ...
                long l_474_ = stream.readUnsignedShort();
                long l_475_ = stream.read24BitUnsignedInteger((byte) 5);
                int rights = stream.readUnsignedByte();
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.CLOSE_INTERFACE_PACKET) {
                int interfaceHash = stream.readIntLE(-2020536115);
                Class343.method4162(1762312694);
                Interface class298_sub51 = ((Interface) client.aClass437_8841.method5812(interfaceHash));
                if (class298_sub51 != null)
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.aClass202_2208) {
            ...
            if (IncommingPacket.IGNORES_PACKET == class25.INCOMMING_PACKET) {
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.aClass202_2218) {//possible
            ...
            if (IncommingPacket.RECEIVE_PRIVATE_MESSAGE_PACKET == class25.INCOMMING_PACKET) {
                boolean bool = stream.readUnsignedByte() == 1;
                ...
                long l = stream.readUnsignedShort();
                long l_489_ = stream.read24BitUnsignedInteger((byte) -115);
                int rights = stream.readUnsignedByte();
            ...
            if (class25.INCOMMING_PACKET == IncommingPacket.IGNORE_PACKET) {
            ...
            IPAddress.method6062(new StringBuilder().append(class25.INCOMMING_PACKET != null ? 2075990793 * (class25.INCOMMING_PACKET.anInt2187) : -1).append(Class26.aString353).append(null != class25.aClass202_345 ? (class25.aClass202_345.anInt2187) * 2075990793 : -1).append(Class26.aString353).append(null != class25.aClass202_348 ? (class25.aClass202_348.anInt2187) * 2075990793 : -1).append(" ").append(class25.anInt336 * -866602563).toString(), new RuntimeException(), (short) -18255);
