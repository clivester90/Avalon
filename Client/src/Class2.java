...
public class Class2 {
	...
	if (f <= f1 && f <= f2) {
		...
		f2 = anInt38;
	    f6 = (f6 - f25 * f3) + f25;
	    float f33 = ((i & 0xff0000) - f27 * f3) + f27;
	    float f36 = ((i & 0xff00) - f29 * f3) + f29;
	    float f39 = ((i & 0xff) - f31 * f3) + f31;
	    if (f1 < f2) {
		f5 = f3;
		if (f < 0.0F) {
		    f5 -= f23 * f;
	...
	if (f1 <= f2) {
		...
		f = anInt38;
	    f7 = (f7 - f25 * f4) + f25;
	    float f34 = ((j & 0xff0000) - f27 * f4) + f27;
	    float f37 = ((j & 0xff00) - f29 * f4) + f29;
	    float f40 = ((j & 0xff) - f31 * f4) + f31;
	    if (f2 < f) {
		f3 = f4;
		if (f1 < 0.0F) {
		    f3 -= f22 * f1;
	...
	if (f1 > anInt38)
	    f1 = anInt38;
	f8 = (f8 - f25 * f5) + f25;
	float f35 = ((k & 0xff0000) - f27 * f5) + f27;
	float f38 = ((k & 0xff00) - f29 * f5) + f29;
	float f41 = ((k & 0xff) - f31 * f5) + f31;
	if (f < f1) {
	    f4 = f5;
	    if (f2 < 0.0F) {
		f4 -= f21 * f2;
	...
	while (l-- > 0) {
		...
		if (l1 != 0)
		    if (l1 != 255) {
			int i2 = 0xff000000 | (int) (f12 * (k1 >> 16 & 0xff)) << 8 & 0xff0000 | (int) (f14 * (k1 >> 8 & 0xff)) & 0xff00 | (int) (f16 * (k1 & 0xff)) >> 8;
			if (f8 != 0.0F) {
			    int k2 = (int) (255F - f8);
			...
			int j2 = 0xff000000 | (int) (f12 * (k1 >> 16 & 0xff)) << 8 & 0xff0000 | (int) (f14 * (k1 >> 8 & 0xff)) & 0xff00 | (int) (f16 * (k1 & 0xff)) >> 8;
			if (f8 != 0.0F) {
			    int i3 = (int) (255F - f8);
	...
	while (l-- > 0) {
		...
		float f36 = f4 * f35;
		float f37 = f6 * f35;
		int i1 = (int) (f36 * anInt39 * aFloat41) & anInt40;
		int j1 = (int) (f37 * anInt39 * aFloat41) & anInt40;
		int k1 = anIntArray30[j1 * anInt39 + i1];
		i1 = (int) (f36 * anInt29 * aFloat32) & anInt28;
		j1 = (int) (f37 * anInt29 * aFloat32) & anInt28;
		int l1 = anIntArray45[j1 * anInt29 + i1];
		i1 = (int) (f36 * anInt51 * aFloat53) & anInt52;
		j1 = (int) (f37 * anInt51 * aFloat53) & anInt52;
		int i2 = anIntArray50[j1 * anInt51 + i1];
		float f38 = 1.0F - (f18 + f20);
		k1 = 0xff000000 | (int) (f18 * (k1 >> 16 & 0xff)) << 16 | (int) (f18 * (k1 >> 8 & 0xff)) << 8 | (int) (f18 * (k1 & 0xff));
		l1 = 0xff000000 | (int) (f20 * (l1 >> 16 & 0xff)) << 16 | (int) (f20 * (l1 >> 8 & 0xff)) << 8 | (int) (f20 * (l1 & 0xff));
		i2 = 0xff000000 | (int) (f38 * (i2 >> 16 & 0xff)) << 16 | (int) (f38 * (i2 >> 8 & 0xff)) << 8 | (int) (f38 * (i2 & 0xff));
		int j2 = k1 + l1 + i2;
		int k2 = 0xff000000 | (int) (f12 * (j2 >> 16 & 0xff)) << 8 & 0xff0000 | (int) (f14 * (j2 >> 8 & 0xff)) & 0xff00 | (int) (f16 * (j2 & 0xff)) >> 8;
		if (f8 != 0.0F) {
		    int l2 = (int) (255F - f8);
