...
public class Class210 {
	...
	try {
	    HashTable class437 = (class403.aClass298_Sub37_Sub17_5260.aClass437Array9685[(class403.anIntArray5257[1883543357 * class403.anInt5259])]);
	    Class298_Sub35 class298_sub35 = ((Class298_Sub35) class437.method5812(class403.anIntArray5244[(class403.anInt5239 -= -391880689) * 681479919]));
	    if (null != class298_sub35)
		class403.anInt5259 += -1065839893 * class298_sub35.anInt7394;
	}
	...
	try {
	    int i_0_ = (class403.anIntArray5257[1883543357 * class403.anInt5259]);
	    Long var_long = (class403.aClass162_5252.method1766(-937307905 * client.gametype.gameType << 16 | i_0_, -2092321657));
	    long l;
	    if (null == var_long)
		l = -1L;
	    else
	...
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub22_7586.method5706((byte) -7) == 1 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    int i_1_ = (class403.anIntArray5244[class403.anInt5239 * 681479919]);
	    int i_2_ = ((class403.anIntArray5244[1 + 681479919 * class403.anInt5239]) - 1);
	    ItemDefinitions class468 = Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(i_1_);
	    if (i_2_ == 690460599 * class468.anInt5736)
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = -1953923599 * class468.anInt5727;
	    else if (i_2_ == class468.anInt5722 * 1689294225)
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = class468.anInt5728 * -1824861577;
	    else
