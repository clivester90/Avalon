...
public class Class301 {
    public static MapDetails aClass298_Sub37_Sub13_3218;
    ...
    static HashTable dungeonMaps = new HashTable(16);
    ...
    protected static MapKeys aClass296_3235;
    ...
    protected static Class243 idx23;
	...
	for (int i_5_ = 0; i_5_ < i_3_; i_5_++) {
		...
		if (i_9_ < 0 || i_9_ >= anInt3239) {
			...
			int i_14_;
			if (aClass298_Sub37_Sub13_3218.anInt9639 * -717907215 != -1)
			    i_14_ = ~0xffffff | (aClass298_Sub37_Sub13_3218.anInt9639) * -717907215;
			...
			if (i_18_ > 0) {
				...
				if ((aClass298_Sub37_Sub13_3218.anInt9639 * -717907215) != -1)
				    i_21_ = (~0xffffff | (aClass298_Sub37_Sub13_3218.anInt9639) * -717907215);
	...
	for (int i_37_ = 0; i_37_ < 3; i_37_++) {
		...
		for (int i_39_ = i_34_; i_39_ <= i_36_; i_39_++) {
			...
			while (iterator.hasNext()) {
			    ...
			    int i_42_ = (i_40_ + class312.aByte3292 - anInt3245 - anInt3230);
			    int i_43_ = (i_41_ + class312.aByte3293 - anInt3238 - anInt3242);
			    ...
			    method3700(class_ra, i_44_, i_46_, i_45_ - i_44_, i_47_ - i_46_, class312.anInt3290, class312.aByte3291 & 0xff, class312.aByte3294, class312.anIntArray3288, class312.aByteArray3289, false);
			}
		    }
		}
	    }
		...
		for (int i_49_ = i_34_; i_49_ <= i_36_; i_49_++) {
			...
			while (iterator.hasNext()) {
			    Class312 class312 = (Class312) iterator.next();
			    int i_52_ = (i_50_ + class312.aByte3292 - anInt3245 - anInt3230);
			    int i_53_ = (i_51_ + class312.aByte3293 - anInt3238 - anInt3242);
			    ...
			    method3701(class_ra, i_54_, i_56_, i_55_ - i_54_, i_57_ - i_56_, class312.anIntArray3288, class312.aByteArray3289);
			}
		    }
		}
	    }
	...
	dungeonMaps.method5811((byte) -118);
	int i = idx23.getArchiveId("details");
	int[] is = idx23.getFileIds(i);
	if (is != null) {
	    for (int i_58_ = 0; i_58_ < is.length; i_58_++) {
		MapDetails class298_sub37_sub13 = WorldMap.getMapDetails(idx23, i, is[i_58_], 1783056581);
		dungeonMaps.method5817(class298_sub37_sub13, (class298_sub37_sub13.fileId) * -947282109);
	    }
	}
	...
	aClass298_Sub37_Sub13_3218 = (MapDetails) dungeonMaps.method5812(i);
    }

    public static Class461 method3693(int i, int i_59_) {
	Class461 class461 = new Class461();
	for (MapDetails class298_sub37_sub13 = ((MapDetails) dungeonMaps.method5816(1759050770)); class298_sub37_sub13 != null; class298_sub37_sub13 = ((MapDetails) dungeonMaps.method5815((byte) -2))) {
	    if (class298_sub37_sub13.load && class298_sub37_sub13.method3450(i, i_59_, (byte) 1))
	...
	for (int i = 0; i < aClass296_3235.anInt3169 * -1407078377; i++) {
	    boolean bool = (aClass298_Sub37_Sub13_3218.method3453(aClass296_3235.keyTiles[i] >> 28 & 0x3, aClass296_3235.keyTiles[i] >> 14 & 0x3fff, aClass296_3235.keyTiles[i] & 0x3fff, is, 1112796822));
	    if (bool) {
		Class298_Sub52 class298_sub52 = new Class298_Sub52(aClass296_3235.keyIds[i]);
		class298_sub52.anInt7607 = (is[1] - anInt3245) * 898378357;
		class298_sub52.anInt7610 = (is[2] - anInt3238) * -1686044477;
		aClass453_3236.add(class298_sub52);
	    }
	}
    }
	...
	RsByteBuffer stream = new RsByteBuffer(idx23.getFile(aClass298_Sub37_Sub13_3218.namehash, "area"));
	int i_121_ = stream.readUnsignedByte();
	int[] is = new int[i_121_];
	for (int i_122_ = 0; i_122_ < i_121_; i_122_++)
	    is[i_122_] = stream.readUnsignedByte();
	int i_123_ = stream.readUnsignedByte();
	int[] is_124_ = new int[i_123_];
	for (int i_125_ = 0; i_125_ < i_123_; i_125_++)
	    is_124_[i_125_] = stream.readUnsignedByte();
	while (stream.index * 385051775 < stream.buffer.length) {
		...
		for (int i_128_ = 0; i_128_ < 64; i_128_++) {
			...
			method3695(class_ra, stream, i_126_, i_127_, i_130_, i_131_, is, is_124_);
		    }
		}
	    } else {
		int i_132_ = stream.readUnsignedByte();
		int i_133_ = stream.readUnsignedByte();
		...
		for (int i_136_ = 0; i_136_ < 8; i_136_++) {
			...
			method3695(class_ra, stream, i_132_, i_133_, i_138_, i_139_, is, is_124_);
		    }
		}
	    }
	}
	...
	for (int i_140_ = 0; i_140_ < 3; i_140_++) {
		...
		for (int i_143_ = 0; i_143_ < anArrayListArrayArrayArray3249[i_140_][0].length; i_143_++) {
			...
			while (iterator.hasNext()) {
			    Class312 class312 = (Class312) iterator.next();
			    is_141_[(i_142_ * 64 + class312.aByte3292 + ((i_143_ * 64 + class312.aByte3293) * anInt3239))] = (byte) class312.anInt3290;
			}
		    }
		}
	    }
		...
		for (int i_145_ = 0; i_145_ < anArrayListArrayArrayArray3249[i_140_][0].length; i_145_++) {
			...
			while (iterator.hasNext()) {
			    Class312 class312 = (Class312) iterator.next();
			    int i_146_ = (i_144_ * 64 + class312.aByte3292 + ((i_145_ * 64 + class312.aByte3293) * anInt3239));
			    class312.anInt3290 = ((aByteArray3243[i_146_] & 0xff) << 16 | aShortArray3244[i_146_] & 0xffff);
			    if (class312.anInt3290 != 0)
				class312.anInt3290 |= ~0xffffff;
			}
		    }
		}
	    }
	...
	if (is != null) {
		...
		if (i_160_ == GameObjectType.T0.type * -1976050083 || (i_160_ == GameObjectType.T2.type * -1976050083) || (i_160_ == GameObjectType.T3.type * -1976050083) || (i_160_ == GameObjectType.T9.type * -1976050083)) {
			...
			if (i_160_ == (GameObjectType.T0.type * -1976050083)) {
			    if (i_162_ == 0)
			...
			} else if (i_160_ == (GameObjectType.T2.type * -1976050083)) {
			    if (i_162_ == 0) {
			...
			} else if (i_160_ == (GameObjectType.T3.type * -1976050083)) {
			    if (i_162_ == 0)
			...
			} else if (i_160_ == (GameObjectType.T9.type * -1976050083)) {
	...
	return (MapDetails) dungeonMaps.method5812(i);
    }
    ...
    public static MapDetails method3708(int i, int i_187_) {
	for (MapDetails class298_sub37_sub13 = ((MapDetails) dungeonMaps.method5816(1588897265)); class298_sub37_sub13 != null; class298_sub37_sub13 = ((MapDetails) dungeonMaps.method5815((byte) -24))) {
	    if (class298_sub37_sub13.load && class298_sub37_sub13.method3450(i, i_187_, (byte) -105))
	...
	for (int i = 0; i < anInt3239; i++) {
		...
		if (object != null) {
			...
			Class298_Sub54 class298_sub54 = (Class298_Sub54) object;
			if (class298_sub54 != null) {
			    for (int i_196_ = 0; i_196_ < (class298_sub54.anIntArray7621).length; i_196_++) {
				ObjectDefinitions class432 = (aClass433_3220.getObjectDefinitions((class298_sub54.anIntArray7621[i_196_])));
	...
	for (int i = 0; i < 3; i++) {
		...
		for (int i_200_ = 0; i_200_ < anArrayListArrayArrayArray3249[0][0].length; i_200_++) {
			...
			while (iterator.hasNext()) {
			    Class312 class312 = (Class312) iterator.next();
			    if (class312.anIntArray3288 != null) {
				for (int i_201_ = 0; i_201_ < (class312.anIntArray3288).length; i_201_++) {
				    ObjectDefinitions class432 = (aClass433_3220.getObjectDefinitions((class312.anIntArray3288[i_201_])));
					...
					class298_sub52.anInt7607 = ((i_199_ + (anInt3245 >> 6)) * 64 + (class312.aByte3292) - anInt3245) * 898378357;
					class298_sub52.anInt7610 = ((i_200_ + (anInt3238 >> 6)) * 64 + (class312.aByte3293) - anInt3238) * -1686044477;
					aClass453_3236.add(class298_sub52);
				    }
				}
			    }
