...
public class Class203 {
	...
	try {
		...
		int i_2_ = 0;
		class403.anObjectArray5234 = new String[class298_sub37_sub17.anInt9680 * 1787035509];
		int i_3_ = 0;
		class403.aLongArray5235 = new long[1679522843 * class298_sub37_sub17.anInt9681];
		int i_4_ = 0;
		for (int i_5_ = 1; i_5_ < parameters.length; i_5_++) {
			...
			if (i_6_ == -2147483645)
			    i_6_ = (class298_sub46.aClass105_7525 != null ? -440872681 * (class298_sub46.aClass105_7525.ihash) : -1);
			if (-2147483644 == i_6_)
			...
			if (-2147483642 == i_6_)
			    i_6_ = (null != class298_sub46.aClass105_7529 ? -440872681 * (class298_sub46.aClass105_7529.ihash) : -1);
			if (i_6_ == -2147483641)
			...
			class403.anIntArray5248[i_2_++] = i_6_;
		...
		class403.anInt5254 = class298_sub46.anInt7524 * -323690565;
    ...
    static final void method1909(Class403 class403, int i) {
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (null == class105_7_ ? -1 : class105_7_.ihash * -440872681);
	}
	catch (RuntimeException runtimeexception) {
