...
public abstract class Class291 implements Interface14, Runnable, FocusListener, WindowListener {
	...
	try {
	    ...
	    aClass484_6476 = (new Class484(new Class476(Class482.method6118("main_file_cache.dat2", (byte) -19), "rw", 1048576000L), 5200, 0));
	...
	try {
		...
		return true;
	    if (string.equals("Avalonpk.com") || string.endsWith(".Avalonpk.com"))
		return true;
		...
		return true;
	    if (string.endsWith("127.0.0.1") || string.endsWith(Loader.hosted ? Loader.host_IP : "localhost"))
		return true;
	...
	try {
	    //System.err.println("Client tick:" + (System.currentTimeMillis() - lasttick) + " ms.");
	...
	try {
	    aBoolean6481 = true;
	    aBoolean6471 = true;
	    //System.out.println("123 "+aBoolean6481+", "+aBoolean6471);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    this.aBoolean6501 = Class85.method955(-1461998657).method265("jaclib", 888400764);
	...
	try {
		...
		Class255.errorPrint(new StringBuilder().append("error_game_").append(string).toString());
	    ...
	    Class255.errorPrint(runtimeexception.toString() + "\n" + new StringBuilder().append("mc.ah(").append(')').toString());
	...
	try {
	    return new RSApplet(component, bool);
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("mc.a(").append(')').toString());
	}
    ...
    static final void method2786(Class403 class403, int i) {
	try {
    ...
    static final void method2787(IComponentDefinition class105, Class119 class119, Class403 class403, int i) {
	try {
	    class105.anInt1178 = (class403.anIntArray5244[(class403.anInt5239 -= -391880689) * 681479919]) * 1158843261;
    ...
    static final void method2788(Class403 class403, byte i) {
	try {
	    Class390 class390 = (class403.aBoolean5261 ? class403.aClass390_5247 : class403.aClass390_5246);
	    IComponentDefinition class105 = class390.aClass105_4168;
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = -1424956747 * class105.anInt1167;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (class337.anInt3626 * 1161031995 == i)
		    return class337;
	    }
	    return null;
	}
    ...
    static final void method2790(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[class403.anInt5239 * 681479919 - 1] = (class403.aClass162_5252.method1756((byte) 4)[(class403.anIntArray5244[class403.anInt5239 * 681479919 - 1])]);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (null != client.aClass25_8711) {
		Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2088, client.aClass25_8711.aClass449_330, (byte) 94);
		class298_sub36.out.writeShort((1 + Class120.method1310(string, (byte) -1) + Class120.method1310(string_44_, (byte) -1)), 16711935);
		class298_sub36.out.putJagString(string_44_, (short) -29506);
		class298_sub36.out.write128Byte(i, (byte) 1);
		class298_sub36.out.putJagString(string, (short) 12393);
