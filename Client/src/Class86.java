...
public class Class86 {
	...
	this.anInt786 = class298_sub53.readBigSmart(1235052657) * 368471857;
	this.aClass424_787 = ((GameObjectType) Class422_Sub20.method5701(ExactStrategy.method4108(114624527), class298_sub53.readUnsignedByte(), (byte) 2));
    }

    void method959(byte i) {
	try {
	    Class420.method5606(-637425735 * this.anInt788, this.anInt789 * -123379955, 1400706617 * this.anInt790, -6749525 * this.aClass424_787.slot, -1, this.aClass424_787.type * -1976050083, this.anInt791 * 1067426701, -694910012);
	}
	...
	try {
	    if (766413265 * this.anInt786 >= 0) {
		ObjectDefinitions class432 = Class463.aClass433_5689.getObjectDefinitions(((this.anInt786) * 766413265));
		boolean bool = class432.method5771((this.aClass424_787.type) * -1976050083, (byte) 42);
	...
	try {
	    Class420.method5606(i, i_3_, i_4_, (-6749525 * this.aClass424_787.slot), 766413265 * this.anInt786, (this.aClass424_787.type * -1976050083), i_5_, -392910268);
	    this.anInt788 = i * -1177932151;
	    this.anInt789 = 1251379141 * i_3_;
	    this.anInt790 = 1672214537 * i_4_;
	    this.anInt791 = 1408522053 * i_5_;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		string_9_ = "_wip";
	    File file_10_ = new File(Class83.aString765, new StringBuilder().append("718Runescape").append(string_7_).append("_preferences").append(string).append(string_9_).append(".dat").toString());
	    do {
	...
	try {
		...
		if (is.length <= 1)
		    return null;
		try {
		    class298_sub37_sub17 = Class163.method1775(is, (byte) 16);
		}
	...
	try {
	    ...
	    double d_17_ = (i >> 8 & 0xff) / 256.0;
	    double d_18_ = (i & 0xff) / 256.0;
	    double d_19_ = d;
	    if (d_17_ < d_19_)
		d_19_ = d_17_;
	    if (d_18_ < d_19_)
    ...
    static final void method965(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = class403.aClass162_5252.aByte1672;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		Class298_Sub36 class298_sub36 = Class18.method359(OutcommingPacket.aClass198_2004, client.aClass25_8711.aClass449_330, (byte) 49);
		class298_sub36.out.writeInt(-1, -735665420);
