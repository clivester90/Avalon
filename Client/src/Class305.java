...
public class Class305 implements Interface27 {
	...
	if (string_1_ == null) {
	    string_1_ = new StringBuilder().append(this.aString6736).append(string_0_).toString();
	    if (!this.aClass243_6735.method2300(string_1_, "", (byte) 15))
		return -1;
	}
	if (!this.aClass243_6735.method2312(string_1_, -2138379227))
	    return this.aClass243_6735.method2305(string_1_, -896654552);
	byte[] is = this.aClass243_6735.getFile(string_1_, "");
	Object object = null;
	File file;
	try {
	...
	try {
	    ...
	    if (string_4_ == null) {
		string_4_ = new StringBuilder().append(this.aString6736).append(string_3_).toString();
		if (!this.aClass243_6735.method2300(string_4_, "", (byte) -89))
		    return -1;
	    }
	    if (!this.aClass243_6735.method2312(string_4_, -2144191880))
		return this.aClass243_6735.method2305(string_4_, 1762657326);
	    byte[] is = this.aClass243_6735.getFile(string_4_, "");
	    Object object = null;
	    File file;
	    try {
	...
	try {
	    this.aHashtable6737.put(string, file);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    return this.aHashtable6737.containsKey(string);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    Enumeration enumeration = this.aHashtable6738.keys();
	    while (enumeration.hasMoreElements()) {
		String string = (String) enumeration.nextElement();
		hashtable.put(string, this.aHashtable6738.get(string));
	    }
	    try {
		...
		try {
		    enumeration = this.aHashtable6738.keys();
		    while (enumeration.hasMoreElements()) {
			String string = (String) enumeration.nextElement();
			try {
			    File file = (File) this.aHashtable6737.get(string);
			    Class var_class_12_ = (Class) this.aHashtable6738.get(string);
	    ...
	    this.aHashtable6738 = hashtable;
	    return this.aHashtable6738.isEmpty();
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		while (enumeration.hasMoreElements()) {
		    ...
		    try {
			File file = ((File) this.aHashtable6737.get(string));
			Class var_class_19_ = ((Class) this.aHashtable6738.get(string));
	...
	try {
		...
		while (enumeration.hasMoreElements()) {
		    ...
		    try {
			File file = ((File) this.aHashtable6737.get(string));
			Class var_class_25_ = ((Class) this.aHashtable6738.get(string));
	...
	try {
	    return this.aHashtable6738.containsKey(string);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		while (enumeration.hasMoreElements()) {
		    ...
		    try {
			File file = ((File) this.aHashtable6737.get(string));
			Class var_class_31_ = ((Class) this.aHashtable6738.get(string));
    ...
    static final void method3748(Class403 class403, int i) {
	try {
	    class403.anInt5239 -= -1175642067;
	    int i_36_ = (class403.anIntArray5244[681479919 * class403.anInt5239]);
	    int i_37_ = (class403.anIntArray5244[1 + class403.anInt5239 * 681479919]);
	    int i_38_ = (class403.anIntArray5244[class403.anInt5239 * 681479919 + 2]);
		...
		throw new RuntimeException();
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = is[i_38_];
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method3749(Class403 class403, byte i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = 1592380953 * client.anInt8669;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method3750(Class403 class403, byte i) {
	try {
	    Class79.method850((class403.aClass365_Sub1_Sub1_Sub2_5242), (class403.anIntArray5244[(class403.anInt5239 -= -391880689) * 681479919]), (byte) 14);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (int) client.aFloatArray8891[0];
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (int) client.aFloatArray8891[1];
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (int) client.aFloatArray8891[2];
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    Class360.aClass25_3905.aClass202_344 = null;
	    Class360.aClass25_3905.aClass202_345 = null;
	    Class360.aClass25_3905.aClass202_348 = null;
	    Class360.aClass25_3905.anInt338 = 0;
	    client.anInt8669 = 0;
	...
	try {
	    Class298_Sub37_Sub12 class298_sub37_sub12 = Class410.method4985(1, i);
	    class298_sub37_sub12.method3449((byte) 4);
	    class298_sub37_sub12.type = i_40_ * 1274450087;
	}
	catch (RuntimeException runtimeexception) {
